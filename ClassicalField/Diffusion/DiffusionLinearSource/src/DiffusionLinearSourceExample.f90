...
PROGRAM DIFFUSIONCONSTANTSOURCEEXAMPLE
  ...
  CALL MPI_BCAST(NUMBER_OF_DOMAINS,1,MPI_INTEGER,0,MPI_COMM_WORLD,MPI_IERROR)
    ...
    ELSE
     ...
     CALL CMISSBasis_InterpolationXiSet(Basis,(/2,2, & 
       & 2/),Err)                         
     CALL CMISSBasis_QuadratureNumberOfGaussXiSet(Basis,(/3,3,3/),Err)
    ENDIF
...
CALL CMISSEquationsSet_CreateStart(EquationsSetUserNumber,Region,GeometricField,CMISS_EQUATIONS_SET_CLASSICAL_FIELD_CLASS, &
    & CMISS_EQUATIONS_SET_DIFFUSION_EQUATION_TYPE,CMISS_EQUATIONS_SET_LINEAR_SOURCE_DIFFUSION_SUBTYPE,EquationsSetFieldUserNumber, &
  ...
  CALL CMISSEquationsSet_AnalyticCreateStart(EquationsSet,CMISS_EQUATIONS_SET_LINEAR_SOURCE_DIFFUSION_THREE_DIM_1, & 
  ...
  !Set the times
  CALL CMISSControlLoop_TimesSet(ControlLoop,0.0_CMISSDP,1.0001_CMISSDP,0.001_CMISSDP,Err)
...
! 
 ...
 !Output Analytic analysis
  ...
  IF(EXPORT_FIELD) THEN
    ...
    CALL CMISSFields_NodesExport(Fields,"DiffusionLinearSource","FORTRAN",Err)
    CALL CMISSFields_ElementsExport(Fields,"DiffusionLinearSource","FORTRAN",Err)
