...
!! \par Latest Builds:
!! http://autotest.bioeng.auckland.ac.nz:8888/builders/x86_64-linux-intel-OpenCMISS/builds/\linux_intel_latest/steps/Monodomain%20Build
!! http://autotest.bioeng.auckland.ac.nz:8888/builders/x86_64-linux-gnu-OpenCMISS/builds/\linux_gnu_latest/steps/Monodomain%20Build
!<
...
PROGRAM MONODOMAINEXAMPLE
  ...
  !CALL DIAGNOSTICS_SET_ON(ALL_DIAG_TYPE,DIAG_LEVEL_LIST,"MonodomainExample",DIAG_ROUTINE_LIST,ERR,ERROR,*999)
  ...
  CALL EQUATIONS_SET_SPECIFICATION_SET(EQUATIONS_SET,EQUATIONS_SET_BIOELECTRICS_CLASS,EQUATIONS_SET_MONODOMAIN_EQUATION_TYPE, &
    & EQUATIONS_SET_NO_SUBTYPE,ERR,ERROR,*999)
...
!  ENDDO !rank_idx
  ...
  CALL PROBLEM_SPECIFICATION_SET(PROBLEM,PROBLEM_BIOELECTRICS_CLASS,PROBLEM_MONODOMAIN_EQUATION_TYPE, &
