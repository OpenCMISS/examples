...
PROGRAM CUBICTRIANGLESIMPLEXEXAMPLE
  ...
  CALL CMISSBasis_InterpolationXiSet(Basis,(/CMISS_BASIS_CUBIC_SIMPLEX_INTERPOLATION, &
    & CMISS_BASIS_CUBIC_SIMPLEX_INTERPOLATION/),Err)
  ...
  CALL CMISSFields_NodesExport(Fields,"CubicTriangleSimplex","FORTRAN",Err)
  CALL CMISSFields_ElementsExport(Fields,"CubicTriangleSimplex","FORTRAN",Err)
