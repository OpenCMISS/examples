...
!  open(unit = 3, file = "./data/hollowcylq-221.in.gpactiv")
 ...
 ! create the gauss point based field, for testing
  ...
  DO E=1,size(Elements,2)
  DO I=1,8
    CALL cmfe_Field_ParameterSetGetGaussPoint(GPfield,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,E,I,1,TMP,Err)
    CALL cmfe_Field_ParameterSetUpdateGaussPoint(GPfield,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,E,I,1,TMP+D,Err)
    CALL cmfe_Field_ParameterSetGetGaussPoint(GPfield,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,E,I,2,TMP,Err)
    CALL cmfe_Field_ParameterSetUpdateGaussPoint(GPfield,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,E,I,2,TMP+D,Err)
    D=D+1
  ENDDO
  ENDDO
