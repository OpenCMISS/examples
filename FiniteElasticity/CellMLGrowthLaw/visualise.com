...
gfx modify g_element "Region 1" node_points glyph sphere general size "0.1*0.1*0.1" centre 0,0,0 
gfx modify g_element "Region 1" lines select_on material default selected_material default_selected
gfx modify g_element "Region 1" surfaces select_on material default data Phi spectrum default selected_material default_selected render_shaded
gfx 
