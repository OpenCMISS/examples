...
PROGRAM SIMPLEXMESHEXAMPLE
  ...
  CALLL BASIS_INTERPOLATION_XI_SET(BASIS,(/BASIS_QUADRATIC_SIMPLEX_INTERPOLATION,BASIS_QUADRATIC_SIMPLEX_INTERPOLATION/), &
    & ERR,ERROR,*999)
  !Finish the creation of the basis
  CALL BASIS_CREATE_FINISH(BASIS,ERR,ERROR,*999)

  !Create a mesh. The mesh will consist of two quadratic Simplex elements.
  NULLIFY(NODES)
  NULLIFY(MESH)
  NULLIFY(MESH_ELEMENTS)
  CALL NODES_CREATE_START(9,REGION,NODES,ERR,ERROR,*999)
  ...
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(GEOMETRIC_FIELD,FIELD_U_VARIABLE_TYPE,1,2,ERR,ERROR,*999)
  ...
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_VALUES_SET_TYPE,1,2,1,FIELD_U_VARIABLE_TYPE,0.5_DP,ERR,ERROR,*999)
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_VALUES_SET_TYPE,1,3,1,FIELD_U_VARIABLE_TYPE,1.0_DP,ERR,ERROR,*999)
  ...
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_VALUES_SET_TYPE,1,5,1,FIELD_U_VARIABLE_TYPE,0.5_DP,ERR,ERROR,*999)
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_VALUES_SET_TYPE,1,6,1,FIELD_U_VARIABLE_TYPE,1.0_DP,ERR,ERROR,*999)
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_VALUES_SET_TYPE,1,7,1,FIELD_U_VARIABLE_TYPE,0.0_DP,ERR,ERROR,*999)
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_VALUES_SET_TYPE,1,8,1,FIELD_U_VARIABLE_TYPE,0.5_DP,ERR,ERROR,*999)
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_VALUES_SET_TYPE,1,9,1,FIELD_U_VARIABLE_TYPE,1.0_DP,ERR,ERROR,*999)
  !Y values
  ...
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_VALUES_SET_TYPE,1,4,2,FIELD_U_VARIABLE_TYPE,0.5_DP,ERR,ERROR,*999)
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_VALUES_SET_TYPE,1,5,2,FIELD_U_VARIABLE_TYPE,0.5_DP,ERR,ERROR,*999)
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_VALUES_SET_TYPE,1,6,2,FIELD_U_VARIABLE_TYPE,0.5_DP,ERR,ERROR,*999)
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_VALUES_SET_TYPE,1,7,2,FIELD_U_VARIABLE_TYPE,1.0_DP,ERR,ERROR,*999)
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_VALUES_SET_TYPE,1,8,2,FIELD_U_VARIABLE_TYPE,1.0_DP,ERR,ERROR,*999)
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_VALUES_SET_TYPE,1,9,2,FIELD_U_VARIABLE_TYPE,1.0_DP,ERR,ERROR,*999)
