!> \file
!> $Id: DarcyExample.f90 20 2007-05-28 20:22:52Z cpb $
...
!!Start to create a default (geometric) field on the region
  ...
  !Set the equations set to be a standard Darcy problem
  CALL EQUATIONS_SET_SPECIFICATION_SET(EQUATIONS_SET,EQUATIONS_SET_CLASSICAL_FIELD_CLASS,EQUATIONS_SET_DARCY_EQUATION_TYPE, &
  ...
  IF(MY_COMPUTATIONAL_NODE_NUMBER==first_local_rank) &
    & CALL BOUNDARY_CONDITIONS_SET_LOCAL_DOF(BOUNDARY_CONDITIONS,FIELD_U_VARIABLE_TYPE,1,BOUNDARY_CONDITION_FIXED,1.0_DP, &
    & ERR,ERROR,*999)
  !Finish the boundary conditions
 ...
 !Create the problem
  ...
  CALL PROBLEM_SPECIFICATION_SET(PROBLEM,PROBLEM_CLASSICAL_FIELD_CLASS,PROBLEM_DARCY_EQUATION_TYPE, &
