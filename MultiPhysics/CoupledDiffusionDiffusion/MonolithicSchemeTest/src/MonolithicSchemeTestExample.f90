...
!   INTEGER(CMFEIntg) :: NumberOfSolidMeshComponents
  ...
  LINEAR_SOLVER_DIFFUSION_STOP_TIME=0.25_CMFEDP 
  LINEAR_SOLVER_DIFFUSION_TIME_INCREMENT=0.125_CMFEDP
...
!     & 1,INITIAL_FIELD_DIFFUSION_THREE,Err)
  ...
  CouplingCoeffs(1,1)=1.0_CMFEDP
  CouplingCoeffs(1,2)=1.0_CMFEDP
  CouplingCoeffs(1,3)=1.0_CMFEDP
  CouplingCoeffs(2,1)=1.0_CMFEDP
  CouplingCoeffs(2,2)=1.0_CMFEDP
  CouplingCoeffs(2,3)=1.0_CMFEDP
  CouplingCoeffs(3,1)=1.0_CMFEDP
  CouplingCoeffs(3,2)=1.0_CMFEDP
  CouplingCoeffs(3,3)=1.0_CMFEDP
