...
These multiscale models restrict higher dimensional (i.e., 3D/1D) models to a region of interest and rely on simpler, lower dimensional (i.e., 0D), models to approximate physical behaviour outside that region.
...
.. literalinclude:: Python/1DTransientExample.py
   :language: python
   :linenos:
