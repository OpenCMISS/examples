...
!    OUTLET_WALL_NODES_NAVIER_STOKES=[TOTAL_NUMBER_OF_NODES]
   !Set initial boundary conditions
...
!  ENDIF
  ...
  DO ELEMENT_NUMBER=1,TOTAL_NUMBER_OF_ELEMENTS
    CALL CMISSMeshElementsNodesSet(MeshElementsSpace,ELEMENT_NUMBER,[(NUMBER_OF_ELEMENT_NODES_SPACE*ELEMENT_NUMBER)-2, &
     & (NUMBER_OF_ELEMENT_NODES_SPACE*ELEMENT_NUMBER)-1,(NUMBER_OF_ELEMENT_NODES_SPACE*ELEMENT_NUMBER)],Err)
  ENDDO
...
CALL CMISSEquationsSetCreateStart(EquationsSetUserNumberNavierStokes,Region,GeometricField, &
    ...
    & CMISSEquationsSet1DTransientNavierStokesSubtype,EquationsSetFieldUserNumber,EquationsSetField,EquationsSetNavierStokes,Err)
