...
PROGRAM DIFFUSIONEXPONENTIALSOURCEEXAMPLE
  ...
  CALL cmfe_EquationsSet_CreateStart(EquationsSetUserNumber,Region,GeometricField,[CMFE_EQUATIONS_SET_CLASSICAL_FIELD_CLASS, &
    & CMFE_EQUATIONS_SET_DIFFUSION_EQUATION_TYPE,CMFE_EQUATIONS_SET_EXPONENTIAL_SOURCE_DIFFUSION_SUBTYPE], &
  ...
  CALL cmfe_AnalyticAnalysis_Output(DependentField,"DiffusionExponentialSourceAnalytic",Err)

  !Output fields
  CALL cmfe_Fields_Initialise(Fields,Err)
  CALL cmfe_Fields_Create(Region,Fields,Err)
  CALL cmfe_Fields_NodesExport(Fields,"DiffusionExponentialSource","FORTRAN",Err)
  CALL cmfe_Fields_ElementsExport(Fields,"DiffusionExponentialSource","FORTRAN",Err)
