...
!> \example FluidMechanics/Stokes/TESTING_ELEMENTS/hex/Quadratic/IterativeSolver/Transient/src/TransientExample.f90
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  BC_NUMBER_OF_WALL_NODES=80
  ALLOCATE(BC_WALL_NODES(BC_NUMBER_OF_WALL_NODES))
  BC_WALL_NODES=(/1,2,3,4,5,7,9,10,11,12,13,14,17,20,24,28,29,30,31,32,33,34,35,37,39, & 
  ...
  BC_INLET_NODES=(/6,15,16,23,36,42,81,82,96/)
