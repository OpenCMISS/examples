...
PROGRAM MEMBRANEEXTENSION3DSPACE
  ...
  CALL CMISSField_ComponentValuesInitialise(MaterialField,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE,1,1.0_CMISSDP,Err)
  CALL CMISSField_ComponentValuesInitialise(MaterialField,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE,2,0.1_CMISSDP,Err)
  ...
  CALL CMISSField_ParametersToFieldParametersComponentCopy(GeometricField,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE, &
    & 2,DependentField,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE,3,Err)
  ...
  CALL CMISSFields_NodesExport(Fields,"MembraneExtension3DSpaceFlat","FORTRAN",Err)
  CALL CMISSFields_ElementsExport(Fields,"MembraneExtension3DSpaceFlat","FORTRAN",Err)
