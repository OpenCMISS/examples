...
#include "mpif.h"
  ...
  CALL cmfe_Basis_InterpolationXiSet(Basis,[CMFE_BASIS_CUBIC_SIMPLEX_INTERPOLATION, &
    & CMFE_BASIS_CUBIC_SIMPLEX_INTERPOLATION],Err)
  ...
  CALL cmfe_Fields_NodesExport(Fields,"CubicTriangleSimplex","FORTRAN",Err)
  CALL cmfe_Fields_ElementsExport(Fields,"CubicTriangleSimplex","FORTRAN",Err)
