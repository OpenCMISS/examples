...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  CALL SOLVER_OUTPUT_TYPE_SET(DYNAMIC_SOLVER,SOLVER_NO_OUTPUT,ERR,ERROR,*999)
!   CALL SOLVER_OUTPUT_TYPE_SET(DYNAMIC_SOLVER,SOLVER_PROGRESS_OUTPUT,ERR,ERROR,*999)
!   CALL SOLVER_OUTPUT_TYPE_SET(DYNAMIC_SOLVER,SOLVER_MATRIX_OUTPUT,ERR,ERROR,*999)
