...
!------------------------------------------------------------------------- 
  ...
  REAL(CMISSDP),DIMENSION(:,:),ALLOCATABLE :: NodeCoords,NodeCoordsMuscle,NodeCoordsExtra
...
!        & NodeCoords(node_idx,1),3,NodeCoords(node_idx,4),Err) !z-position
  ...
  NodeCoordsExtra(1,:)=[0.0_CMISSDP,0.05_CMISSDP,-0.1_CMISSDP]
  NodeCoordsExtra(2,:)=[0.0344828_CMISSDP,0.05_CMISSDP,-0.1_CMISSDP]
  NodeCoordsExtra(3,:)=[0.0_CMISSDP,0.15_CMISSDP,-0.1_CMISSDP]
  NodeCoordsExtra(4,:)=[0.0344828_CMISSDP,0.15_CMISSDP,-0.1_CMISSDP]

  NodeCoordsExtra(5,:)=[0.0_CMISSDP,0.05_CMISSDP,-0.3_CMISSDP]
  NodeCoordsExtra(6,:)=[0.0344828_CMISSDP,0.05_CMISSDP,-0.3_CMISSDP]
  NodeCoordsExtra(7,:)=[0.0_CMISSDP,0.15_CMISSDP,-0.3_CMISSDP]
  NodeCoordsExtra(8,:)=[0.0344828_CMISSDP,0.15_CMISSDP,-0.3_CMISSDP]
  
  NodeCoordsExtra(9,:)=[0.0_CMISSDP,0.05_CMISSDP,-0.5_CMISSDP]
  NodeCoordsExtra(10,:)=[0.0344828_CMISSDP,0.05_CMISSDP,-0.5_CMISSDP]
  NodeCoordsExtra(11,:)=[0.0_CMISSDP,0.15_CMISSDP,-0.5_CMISSDP]
  NodeCoordsExtra(12,:)=[0.0344828_CMISSDP,0.15_CMISSDP,-0.5_CMISSDP]
  
  NodeCoordsExtra(13,:)=[0.0_CMISSDP,0.05_CMISSDP,-0.7_CMISSDP]
  NodeCoordsExtra(14,:)=[0.0344828_CMISSDP,0.05_CMISSDP,-0.7_CMISSDP]
  NodeCoordsExtra(15,:)=[0.0_CMISSDP,0.15_CMISSDP,-0.7_CMISSDP]
  NodeCoordsExtra(16,:)=[0.0344828_CMISSDP,0.15_CMISSDP,-0.7_CMISSDP]      
