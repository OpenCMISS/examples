...
PROGRAM LINEARTRIANGLESIMPLEXEXAMPLE
  ...
  CALL CMISSBasis_InterpolationXiSet(Basis,(/CMISS_BASIS_LINEAR_SIMPLEX_INTERPOLATION, &
    & CMISS_BASIS_LINEAR_SIMPLEX_INTERPOLATION/),Err)
  ...
  CALL CMISSFields_NodesExport(Fields,"LinearTriangleSimplex","FORTRAN",Err)
  CALL CMISSFields_ElementsExport(Fields,"LinearTriangleSimplex","FORTRAN",Err)
