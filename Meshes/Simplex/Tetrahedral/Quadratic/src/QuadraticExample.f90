...
PROGRAM QUADRATICTETRAHEDRASIMPLEXEXAMPLE
  ...
  CALL CMISSFields_NodesExport(Fields,"QuadraticTetrahedraSimplex","FORTRAN",Err)
  CALL CMISSFields_ElementsExport(Fields,"QuadraticTetrahedraSimplex","FORTRAN",Err)
