...
999 CALL ERRORS("ANALYTICLAPLACE_GENERIC_CONVERGENCE",ERR,ERROR)
  ...
  SUBROUTINE ANALYTICLAPLACE_GENERIC(WORLD_REGION,NUMBER_GLOBAL_X_ELEMENTS,NUMBER_GLOBAL_Y_ELEMENTS,NUMBER_GLOBAL_Z_ELEMENTS, &
    ...
    IF(ASSOCIATED(REGIONS%WORLD_REGION)) THEN
      !Destroy regions except the global region
      DO i=1,REGIONS%WORLD_REGION%NUMBER_OF_SUB_REGIONS
        CALL REGION_DESTROY(REGIONS%WORLD_REGION%SUB_REGIONS(i)%PTR%USER_NUMBER,ERR,ERROR,*999)
      ENDDO !region
    ENDIF
    NULLIFY(REGION)
