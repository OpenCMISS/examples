...
gfx modify spectrum pressure linear reverse range -13 13 extend_above extend_below rainbow colour_range 0 1 component 4;

gfx modify g_element OpenCMISS node_points glyph arrow_solid general size "0.3*0.3*0.3" centre 0,0,0 select_on material default selected_material default_selected data mag_1 orientation vector_field scale_factors "0.01*0.01*0.01" spectrum flow
