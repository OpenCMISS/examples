...
PROGRAM LAPLACEEXAMPLE
  ...
  ELSE
    ...
    CALL BASIS_TYPE_SET(BASIS2,2,ERR,ERROR,*999)  
    CALL BASIS_INTERPOLATION_XI_SET(BASIS2,(/7,7,7/),ERR,ERROR,*999)
...
!!Start to create a default (geometric) field on the region
  ...
  CALL EQUATIONS_SET_SPECIFICATION_SET(EQUATIONS_SET,EQUATIONS_SET_FLUID_MECHANICS_CLASS,EQUATIONS_SET_LAPLACE_EQUATION_TYPE, &
