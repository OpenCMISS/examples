...
!   POROSITY_PARAM_DARCY=0.3_CMISSDP  !??? Also try with porosity unequal 1.0
  ...
  ! 1=CMISS_EQUATIONS_SET_DARCY_EQUATION_TWO_DIM_1
  ! 2=CMISS_EQUATIONS_SET_DARCY_EQUATION_TWO_DIM_2
  ! 3=CMISS_EQUATIONS_SET_DARCY_EQUATION_TWO_DIM_3
  ! 4=CMISS_EQUATIONS_SET_DARCY_EQUATION_THREE_DIM_1
  ! 5=CMISS_EQUATIONS_SET_DARCY_EQUATION_THREE_DIM_2
  ! 6=CMISS_EQUATIONS_SET_DARCY_EQUATION_THREE_DIM_3
...
!   ENDIF
  ...
  IF(INPUT_TYPE==1.AND.NUMBER_OF_DIMENSIONS==2) ANALYTICAL_TYPE=CMISS_EQUATIONS_SET_DARCY_EQUATION_TWO_DIM_1
  IF(INPUT_TYPE==2.AND.NUMBER_OF_DIMENSIONS==2) ANALYTICAL_TYPE=CMISS_EQUATIONS_SET_DARCY_EQUATION_TWO_DIM_2
  IF(INPUT_TYPE==3.AND.NUMBER_OF_DIMENSIONS==2) ANALYTICAL_TYPE=CMISS_EQUATIONS_SET_DARCY_EQUATION_TWO_DIM_3
  IF(INPUT_TYPE==1.AND.NUMBER_OF_DIMENSIONS==3) ANALYTICAL_TYPE=CMISS_EQUATIONS_SET_DARCY_EQUATION_THREE_DIM_1
  IF(INPUT_TYPE==2.AND.NUMBER_OF_DIMENSIONS==3) ANALYTICAL_TYPE=CMISS_EQUATIONS_SET_DARCY_EQUATION_THREE_DIM_2
  IF(INPUT_TYPE==3.AND.NUMBER_OF_DIMENSIONS==3) ANALYTICAL_TYPE=CMISS_EQUATIONS_SET_DARCY_EQUATION_THREE_DIM_3
...
CALL CMISSEquationsSet_CreateStart(EquationsSetUserNumberDarcy,Region,GeometricField,CMISS_EQUATIONS_SET_FLUID_MECHANICS_CLASS, &
    & CMISS_EQUATIONS_SET_DARCY_EQUATION_TYPE,CMISS_EQUATIONS_SET_STANDARD_DARCY_SUBTYPE,EquationsSetFieldUserNumber, &
      & EquationsSetField, &
  ...
  IF(NUMBER_OF_DIMENSIONS==2) THEN  
    CALL CMISSEquationsSet_AnalyticCreateStart(EquationsSetDarcy,ANALYTICAL_TYPE,AnalyticFieldUserNumberDarcy, &
  ...
  CALL CMISSEquations_OutputTypeSet(EquationsDarcy,1,Err)
  ...
  CALL CMISSSolverEquations_BoundaryConditionsCreateStart(SolverEquationsDarcy,BoundaryConditions,Err)
  ...
  IF(EXPORT_FIELD_IO) THEN
    ...
    CALL CMISSFields_NodesExport(Fields,"Darcy","FORTRAN",Err)
    CALL CMISSFields_ElementsExport(Fields,"Darcy","FORTRAN",Err)
