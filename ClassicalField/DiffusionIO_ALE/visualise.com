gfx read node DiffusionIO.part0.exnode
gfx read element DiffusionIO.part0.exelem generate
gfx create window 1
...
gfx modify window 1 image rotate -1 0 0 -100
gfx modify window 1 image rotate 0 0 1 -25
gfx modify window 1 image rotate 0 0 1 +50
gfx modify window 1 image rotate 1 1 0 -45
gfx modify window 1 image rotate 1 1 0 +15
gfx modify window 1 image rotate 1 0 1 -15
gfx modify window 1 image rotate 0 0 1 +15
gfx
