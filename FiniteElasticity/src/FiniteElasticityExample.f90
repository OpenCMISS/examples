...
PROGRAM FINITEELASTICITYEXAMPLE
  ...
  CALL FIELD_ADD_FIELD_COMPONENT_TO_ANOTHER_FIELD_COMPONENT(GEOMETRIC_FIELD,1,1,DEPENDENT_FIELD,1,1,ERR,ERROR,*999)
  CALL FIELD_ADD_FIELD_COMPONENT_TO_ANOTHER_FIELD_COMPONENT(GEOMETRIC_FIELD,1,2,DEPENDENT_FIELD,1,2,ERR,ERROR,*999)
  CALL FIELD_ADD_FIELD_COMPONENT_TO_ANOTHER_FIELD_COMPONENT(GEOMETRIC_FIELD,1,3,DEPENDENT_FIELD,1,3,ERR,ERROR,*999)  
  CALL FIELD_COMPONENT_VALUES_INITIALISE(DEPENDENT_FIELD,FIELD_U_VARIABLE_TYPE,4,FIELD_VALUES_SET_TYPE,-5.0_DP,ERR,ERROR,*999)
