...
!    & 1.0_DP,ERR,ERROR,*999)
  ...
  IF(NUMBER_GLOBAL_Z_ELEMENTS/=0) THEN
    ...
    DO node_idx=1,NUMBER_OF_NODES
      ...
      IF (node_x==0.0_DP.OR.node_x==WIDTH.OR.node_y==0.0_DP.OR.node_y==HEIGHT.OR.node_z==0.0_DP.OR.node_z==LENGTH) THEN 
        value=cos(node_x)*cosh(node_y)*node_z
  ...
  IF(NUMBER_GLOBAL_Z_ELEMENTS/=0) THEN
    CALL EQUATIONS_SET_ANAYLITIC_EQUATION_NUMBER_SET(EQUATIONS_SET,LAPLACE_EQUATION_THREE_DIM_2,ERR,ERROR,*999)
  ELSE
    CALL EQUATIONS_SET_ANAYLITIC_EQUATION_NUMBER_SET(EQUATIONS_SET,LAPLACE_EQUATION_TWO_DIM_2,ERR,ERROR,*999)
  ENDIF
  !Finish the equations set dependent field variables
