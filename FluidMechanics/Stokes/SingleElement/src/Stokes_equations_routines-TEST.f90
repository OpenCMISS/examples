...
! CHECK STIFFNESS MATRIX WITH CMHEART
          OPEN(UNIT=79, FILE='./output/OPENCMISS.mat')
! reordering
         test=STIFFNESS_MATRIX%ELEMENT_MATRIX%MATRIX(1:89,1:89)
         test2=test
         DO i=1,3
            test2(:,1+(i-1)*27)=test(:,1+(i-1)*27)
            test2(:,9+(i-1)*27)=test(:,2+(i-1)*27)
            test2(:,2+(i-1)*27)=test(:,3+(i-1)*27)
            test2(:,10+(i-1)*27)=test(:,4+(i-1)*27)
            test2(:,11+(i-1)*27)=test(:,5+(i-1)*27)
            test2(:,12+(i-1)*27)=test(:,6+(i-1)*27)
            test2(:,3+(i-1)*27)=test(:,7+(i-1)*27)
            test2(:,13+(i-1)*27)=test(:,8+(i-1)*27)
            test2(:,4+(i-1)*27)=test(:,9+(i-1)*27)
            test2(:,14+(i-1)*27)=test(:,10+(i-1)*27)
            test2(:,15+(i-1)*27)=test(:,11+(i-1)*27)
            test2(:,16+(i-1)*27)=test(:,12+(i-1)*27)
            test2(:,17+(i-1)*27)=test(:,13+(i-1)*27)
            test2(:,18+(i-1)*27)=test(:,14+(i-1)*27)
            test2(:,19+(i-1)*27)=test(:,15+(i-1)*27)
            test2(:,20+(i-1)*27)=test(:,16+(i-1)*27)
            test2(:,21+(i-1)*27)=test(:,17+(i-1)*27)
            test2(:,22+(i-1)*27)=test(:,18+(i-1)*27)
            test2(:,5+(i-1)*27)=test(:,19+(i-1)*27)
            test2(:,23+(i-1)*27)=test(:,20+(i-1)*27)
            test2(:,6+(i-1)*27)=test(:,21+(i-1)*27)
            test2(:,24+(i-1)*27)=test(:,22+(i-1)*27)
            test2(:,25+(i-1)*27)=test(:,23+(i-1)*27)
            test2(:,26+(i-1)*27)=test(:,24+(i-1)*27)
            test2(:,7+(i-1)*27)=test(:,25+(i-1)*27)
            test2(:,27+(i-1)*27)=test(:,26+(i-1)*27)
            test2(:,8+(i-1)*27)=test(:,27+(i-1)*27)
         END DO
         test=test2
         DO i=1,3
            test(1+(i-1)*27,:)=test2(1+(i-1)*27,:)
            test(9+(i-1)*27,:)=test2(2+(i-1)*27,:)
            test(2+(i-1)*27,:)=test2(3+(i-1)*27,:)
            test(10+(i-1)*27,:)=test2(4+(i-1)*27,:)
            test(11+(i-1)*27,:)=test2(5+(i-1)*27,:)
            test(12+(i-1)*27,:)=test2(6+(i-1)*27,:)
            test(3+(i-1)*27,:)=test2(7+(i-1)*27,:)
            test(13+(i-1)*27,:)=test2(8+(i-1)*27,:)
            test(4+(i-1)*27,:)=test2(9+(i-1)*27,:)
            test(14+(i-1)*27,:)=test2(10+(i-1)*27,:)
            test(15+(i-1)*27,:)=test2(11+(i-1)*27,:)
            test(16+(i-1)*27,:)=test2(12+(i-1)*27,:)
            test(17+(i-1)*27,:)=test2(13+(i-1)*27,:)
            test(18+(i-1)*27,:)=test2(14+(i-1)*27,:)
            test(19+(i-1)*27,:)=test2(15+(i-1)*27,:)
            test(20+(i-1)*27,:)=test2(16+(i-1)*27,:)
            test(21+(i-1)*27,:)=test2(17+(i-1)*27,:)
            test(22+(i-1)*27,:)=test2(18+(i-1)*27,:)
            test(5+(i-1)*27,:)=test2(19+(i-1)*27,:)
            test(23+(i-1)*27,:)=test2(20+(i-1)*27,:)
            test(6+(i-1)*27,:)=test2(21+(i-1)*27,:)
            test(24+(i-1)*27,:)=test2(22+(i-1)*27,:)
            test(25+(i-1)*27,:)=test2(23+(i-1)*27,:)
            test(26+(i-1)*27,:)=test2(24+(i-1)*27,:)
            test(7+(i-1)*27,:)=test2(25+(i-1)*27,:)
            test(27+(i-1)*27,:)=test2(26+(i-1)*27,:)
            test(8+(i-1)*27,:)=test2(27+(i-1)*27,:)
         END DO
         test2=0.0
! first block          
          DO mh=1,27
...
!reordering again
         ...
         END DO
          DO mh=1,89
            scaling=0.0
            DO nh=1,81
               square=ABS(test2(mh,nh))
               IF(square>scaling) THEN
                  scaling=square
               END IF
            END DO
             scaling=1.0
             test(mh,1:89)=test2(mh,1:89)/scaling
          END DO
! writing out
  DO mh=1,81
    DO nh=1,89
      WRITE(79,*)mh,nh,test(mh,nh)
    END DO
  END DO
  DO mh=82,89
    DO nh=1,81
...
! ! CHECK STIFFNESS MATRIX WITH CMHEART
!           OPEN(UNIT=88, FILE='./output/DAMPING.mat')
! ! reordering
!          test=DAMPING_MATRIX%ELEMENT_MATRIX%MATRIX(1:89,1:89)
!          test2=test
!          DO i=1,3
!             test2(:,1+(i-1)*27)=test(:,1+(i-1)*27)
!             test2(:,9+(i-1)*27)=test(:,2+(i-1)*27)
