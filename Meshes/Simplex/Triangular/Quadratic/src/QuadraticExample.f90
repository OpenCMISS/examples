!> \file
!> $Id: QuadraticTriangleSimplexExample.f90 20 2007-05-28 20:22:52Z cpb $
...
PROGRAM QUADRATICTRIANGLESIMPLEXEXAMPLE
  ...
  CALL CMISSFieldIONodesExport(Fields,"QuadraticTriangleSimplex","FORTRAN",Err)
  CALL CMISSFieldIOElementsExport(Fields,"QuadraticTriangleSimplex","FORTRAN",Err)
