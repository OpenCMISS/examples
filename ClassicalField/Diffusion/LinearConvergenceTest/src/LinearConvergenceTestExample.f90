...
PROGRAM DIFFUSIONEXAMPLE
  ...
  CALL CMISSEquationsSet_CreateStart(EquationsSetUserNumber,Region,GeometricField,CMISS_EQUATIONS_SET_CLASSICAL_FIELD_CLASS, &
    & CMISS_EQUATIONS_SET_DIFFUSION_EQUATION_TYPE,CMISS_EQUATIONS_SET_NO_SOURCE_DIFFUSION_SUBTYPE,&
    & EquationsSetFieldUserNumber,EquationsSetField,EquationsSet,Err)
  !Set the equations set to be a standard Laplace problem
!   CALL CMISSEquationsSet_SpecificationSet(EquationsSet,CMISS_EQUATIONS_SET_CLASSICAL_FIELD_CLASS, &
!     & CMISS_EQUATIONS_SET_DIFFUSION_EQUATION_TYPE,CMISS_EQUATIONS_SET_NO_SOURCE_DIFFUSION_SUBTYPE,Err)
...
!   CALL PROBLEM_SOLVERS_CREATE_FINISH(PROBLEM,ERR,ERROR,*999)
  ...
  IF(EXPORT_FIELD) THEN
    ...
    CALL CMISSFields_NodesExport(Fields,"Diffusion_x40_y40_L_T1","FORTRAN",Err)
    CALL CMISSFields_ElementsExport(Fields,"Diffusion_x40_y40_L_T1","FORTRAN",Err)
