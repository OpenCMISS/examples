!> \file
!> $Id: GeodesicEx1Example.f90 20 2007-05-28 20:22:52Z cpb $
!> \author Ali PASHAEI
...
!...................................................................................
  ...
  REAL(CMISSDP), ALLOCATABLE, DIMENSION(:,:):: NODE_LIST
  REAL(CMISSDP), ALLOCATABLE, DIMENSION(:,:):: SPEED_FUNCTION_TABLE
  REAL(CMISSDP), ALLOCATABLE, DIMENSION(:,:):: CONDUCTIVITY_TENSOR
  REAL(CMISSDP), ALLOCATABLE, DIMENSION(:,:):: SPEED_FUNCTION_TABLE_ON_CONNECTIVITY
  REAL(CMISSDP), ALLOCATABLE, DIMENSION(:,:):: CONDUCTIVITY_TENSOR_ON_CONNECTIVITY
  REAL(CMISSDP), ALLOCATABLE, DIMENSION(:)  :: SEED_VALUE
  REAL(CMISSDP), ALLOCATABLE, DIMENSION(:)  :: SNAPSHOT_SEED_VALUE
  REAL(CMISSDP), ALLOCATABLE, DIMENSION(:)  :: RELATIVE_ERROR
  REAL(CMISSDP), ALLOCATABLE, DIMENSION(:)  :: SEED_VALUE_EXACT_SOLUTION
  REAL(CMISSDP), ALLOCATABLE, DIMENSION(:)  :: TRACE_NODES
...
!  Allocate parameters
  ...
  SEED_VALUE(SEED_POINT)=0.0_CMISSDP
  TRACE_NODE(SEED_POINT)=0

  INPUT_TYPE_FOR_SPEED_FUNCTION = "FIXED" 
  SPEED_FUNCTION_ALONG_EIGEN_VECTOR(1) = 1.0_CMISSDP
...
&TOTAL_NUMBER_OF_CONNECTIVITY,CONNECTIVITY_LIST,ELEMENT_LIST,TOTAL_NUMBER_OF_ELEMENTS,NUMBER_OF_NODES_PER_ELEMENT,Err)
  ...
  CALL CMISS_SOLVE_PROBLEM_GEODESIC_CONNECTIVITY(TOTAL_NUMBER_OF_NODES,NODE_LIST,CONDUCTIVITY_TENSOR_ON_CONNECTIVITY,&
