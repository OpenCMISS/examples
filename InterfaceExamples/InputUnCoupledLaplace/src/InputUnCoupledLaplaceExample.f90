...
PROGRAM THREEDCOUPLEDLAPLACE
  ...
  INTEGER(CMFEIntg) :: y_element_idx,z_element_idx,mesh_local_y_node,mesh_local_z_node,ic_idx
  REAL(CMFEDP) :: XI2(2),XI3(3),VALUE
...
!   INTEGER(CMFEIntg) :: NUMBER_OF_ELEMENT_NODES_PRESSURE1,NUMBER_OF_ELEMENT_NODES_PRESSURE2
  ...
  INTEGER(CMFEIntg) :: ELEMENT_NUMBER,COMPONENT_NUMBER,NODE_NUMBER
