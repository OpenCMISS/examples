...
PROGRAM COUPLEDSTOKES
  ...
  REAL(CMISSRP) :: BOUNDARY_CONDITIONS1(3)
  ...
  REAL(CMISSRP) :: BOUNDARY_CONDITIONS2(3)
  LOGICAL :: FIXED_WALL_NODES2_FLAG=.TRUE.
  LOGICAL :: INLET_WALL_NODES2_FLAG=.TRUE.


  REAL(CMISSRP) :: RHO_PARAM=1.0_CMISSRP
  REAL(CMISSRP) :: MU_PARAM=1.0_CMISSRP
  ...
  IF(INLET_WALL_NODES1_FLAG) THEN
    ...
    BOUNDARY_CONDITIONS1(1)=1.0_CMISSRP
    BOUNDARY_CONDITIONS1(2)=0.0_CMISSRP
    BOUNDARY_CONDITIONS1(3)=0.0_CMISSRP
  ENDIF
  ...
  IF(INLET_WALL_NODES2_FLAG) THEN
    ...
    !Set initial boundary conditions
    BOUNDARY_CONDITIONS2(1)=1.0_CMISSRP
    BOUNDARY_CONDITIONS2(2)=0.0_CMISSRP
    BOUNDARY_CONDITIONS2(3)=0.0_CMISSRP
  ENDIF
