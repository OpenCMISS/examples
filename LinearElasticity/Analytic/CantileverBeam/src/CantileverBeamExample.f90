...
PROGRAM ANALYTIC_LINEAR_ELASTICITYEXAMPLE
  ...
  REAL(CMFEDP), PARAMETER :: ORIGIN(3)=(/0.0_CMFEDP,-1.0_CMFEDP,-1.0_CMFEDP/)
...
!    ELSE
      ...
      MaterialParameters = (/10.0E3_CMFEDP,10.0E3_CMFEDP,10.0E3_CMFEDP,0.45_CMFEDP,0.45_CMFEDP,0.45_CMFEDP/)
!    ENDIF
