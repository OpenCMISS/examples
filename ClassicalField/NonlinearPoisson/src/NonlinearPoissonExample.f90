...
!!Start to create a default (geometric) field on the region
  ...
  IF(NUMBER_GLOBAL_Z_ELEMENTS==0) THEN  
    CALL EQUATIONS_SET_ANALYTIC_CREATE_START(EQUATIONS_SET,EQUATIONS_SET_POISSON_EQUATION_TWO_DIM_1,4,ANALYTIC_FIELD, &
      & ERR,ERROR,*999)
  ELSE
    CALL FLAG_ERROR("Three dimensions is not implemented.",ERR,ERROR,*999)
  ENDIF
