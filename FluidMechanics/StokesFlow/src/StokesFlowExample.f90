...
!> \example StokesFlow/src/StokesFlowExample.f90
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!Define boundary conditions for M=linear
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

! ! !    BC_NUMBER_OF_WALL_NODES=312
! ! !    ALLOCATE(BC_WALL_NODES(BC_NUMBER_OF_WALL_NODES))
! ! !    BC_WALL_NODES=(/1,2,3,5,6,7,9,11,13,15,17,18,19,20,21,23,29,30,31,33,39,40,41,43,49,50,51,&
! ! !    &53,59,60,61,63,69,70,71,73,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,95,97,99,100,101,&
! ! !    &105,106,110,111,115,116,120,121,125,126,130,131,132,133,134,135,136,137,138,140,142,144,&
! ! !    &145,146,150,151,155,156,160,161,165,166,170,171,175,176,177,178,179,180,181,182,183,185,187,&
! ! !    &189,190,191,195,196,200,201,205,206,210,211,215,216,220,221,222,223,224,225,226,227,228,230,&
! ! !    &232,234,235,236,240,241,245,246,250,251,255,256,260,261,265,266,267,268,269,270,271,272,273,&
! ! !    &275,277,279,280,281,285,286,290,291,295,296,300,301,305,306,310,311,312,313,314,315,316,317,&
! ! !    &318,320,322,324,325,326,330,331,335,336,340,341,345,346,350,351,355,356,357,358,359,360,361,&
! ! !    &362,363,365,367,369,370,371,375,376,380,381,385,386,390,391,395,396,400,401,402,403,404,405,&
! ! !    &406,407,408,410,412,414,415,416,420,421,425,426,430,431,435,436,440,441,445,446,447,448,449,&
! ! !    &450,451,452,453,455,457,459,460,461,465,466,470,471,475,476,480,481,485,486,490,491,492,493,&
! ! !    &494,495,496,497,498,500,502,504,505,506,510,511,515,516,520,521,525,526,530,531,535,536,537,&
! ! !    &538,539,540,541,542,543,545,547,549,550,551,555,556,560,561,565,566,570,571,575,576,580,581,&
! ! !    582,583,584,585/)
! ! ! 
! ! ! 
! ! ! 
! ! ! 
! ! !   BC_NUMBER_OF_INLET_NODES=21
! ! !   ALLOCATE(BC_INLET_NODES(BC_NUMBER_OF_INLET_NODES))
! ! !   BC_INLET_NODES=(/4,10,14,22,25,27,32,35,37,42,45,47,52&
! ! !   &,55,57,62,65,67,72,75,77/)


!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!Define boundary conditions for M=quadratic
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  ALLOCATE(BC_INLET_NODES(BC_NUMBER_OF_INLET_NODES))
  BC_INLET_NODES=(/4,11,12,13,29,33,34,35,47,51,52,53,69,71,&
  &83,87,88,89,100,102,103,104,112,114,115,116,126,128,137,141,142,143,154,156,&
  &157,158,166,168,169,170,180,182,191,195,196,197,208,210,211,212,220,222,223,224,&
  &234,236,245,249,250,251,262,264,265,266,274,276,277,278,288,290,299,&
  &303,304,305,316,318,319,320,328,330,331,332,342,344,353,357,358,359,370,372,&
  &373,374,382,384,385,386,396,398,411,412,426,427,438,439,&
  &450/)


!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!Define boundary conditions for M=cubic
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

! ! ! !    BC_NUMBER_OF_WALL_NODES=
! ! ! !    ALLOCATE(BC_WALL_NODES(BC_NUMBER_OF_WALL_NODES))
! ! ! !    BC_WALL_NODES=(/ /)
! ! ! ! 
! ! ! ! 
! ! ! ! 
! ! ! !   BC_NUMBER_OF_INLET_NODES=
! ! ! !   ALLOCATE(BC_INLET_NODES(BC_NUMBER_OF_INLET_NODES))
! ! ! !   BC_INLET_NODES=(/ /)
