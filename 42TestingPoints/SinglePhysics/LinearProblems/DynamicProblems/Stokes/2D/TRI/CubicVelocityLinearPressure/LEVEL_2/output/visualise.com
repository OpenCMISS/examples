...
gfx modify spectrum pressure linear reverse range -1 1 extend_above extend_below rainbow colour_range 0 1 component 3;
...
gfx edit scene
gfx edit spectrum
gfx define field p_field coordinate_system rectangular_cartesian composite general.3;
gfx define field vector_field coordinate_system rectangular_cartesian composite general.1 general.2;
gfx define field mag_field coordinate_system rectangular_cartesian magnitude field vector_field;
gfx modify spectrum default clear overwrite_colour;
gfx modify spectrum default linear reverse range -1.52137 0.282306 extend_above extend_below rainbow colour_range 0 1 component 1;
gfx modify spectrum flow clear overwrite_colour;
gfx modify spectrum flow linear reverse range 1 1.25 extend_above extend_below rainbow colour_range 0 1 component 2;
...
gfx modify g_element OpenCMISS node_points glyph arrow_solid general size "1*1*1" centre 0,0,0 font default orientation vector_field scale_factors "1*1*1" select_on material default data mag_field spectrum default selected_material default_selected;
...
gfx modify window 1 view parallel eye_point -5.14426 -26.338 22.9826 interest_point 0 0 0 up_vector 0.282893 0.598662 0.749384 view_angle 40 near_clipping_plane 0.353321 far_clipping_plane 126.265 relative_viewport ndc_placement -1 1 2 2 viewport_coordinates 0 0 1 1;
