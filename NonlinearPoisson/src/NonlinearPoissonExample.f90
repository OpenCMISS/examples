...
PROGRAM NONLINEARPOISSONEXAMPLE
  ...
  REAL(DP), PARAMETER :: HEIGHT=2.0_DP
  ...
  !CALL DIAGNOSTICS_SET_ON(ALL_DIAG_TYPE,DIAG_LEVEL_LIST,"NonlinearPoissonExample",DIAG_ROUTINE_LIST,ERR,ERROR,*999)
  ...
  !Set the equations set to be a quadratic source nonlinear Poisson problem
  !CALL EQUATIONS_SET_SPECIFICATION_SET(EQUATIONS_SET,EQUATIONS_SET_CLASSICAL_FIELD_CLASS,EQUATIONS_SET_POISSON_EQUATION_TYPE, &
  !  & EQUATIONS_SET_QUADRATIC_SOURCE_POISSON_SUBTYPE,ERR,ERROR,*999)
  CALL EQUATIONS_SET_SPECIFICATION_SET(EQUATIONS_SET,EQUATIONS_SET_CLASSICAL_FIELD_CLASS,EQUATIONS_SET_POISSON_EQUATION_TYPE, &
    & EQUATIONS_SET_EXPONENTIAL_SOURCE_POISSON_SUBTYPE,ERR,ERROR,*999)
  ...
  !CALL FIELD_PARAMETER_SETS_COPY(EQUATIONS_SET%DEPENDENT%DEPENDENT_FIELD,FIELD_ANALYTIC_VALUES_SET_TYPE,FIELD_VALUES_SET_TYPE,ERR,ERROR,*999)
...
!    & 0.0_DP,ERR,ERROR,*999)
  ...
  !IF(MY_COMPUTATIONAL_NODE_NUMBER==last_local_rank) &
  !  & CALL EQUATIONS_SET_FIXED_CONDITIONS_SET_DOF(EQUATIONS_SET,9,EQUATIONS_SET_FIXED_BOUNDARY_CONDITION, &
  !  & 0.0_DP,ERR,ERROR,*999)
  !Finish the problem fixed conditions
!  CALL EQUATIONS_SET_FIXED_CONDITIONS_CREATE_FINISH(EQUATIONS_SET,ERR,ERROR,*999)
  ...
  !Set the problem to be a nonlinear Poisson problem
  CALL PROBLEM_SPECIFICATION_SET(PROBLEM,PROBLEM_CLASSICAL_FIELD_CLASS,PROBLEM_POISSON_EQUATION_TYPE, &
    & PROBLEM_NONLINEAR_SOURCE_POISSON_SUBTYPE,ERR,ERROR,*999)
...
!  CALL SOLVER_NEWTON_ABSOLUTE_TOLERANCE_SET(SOLVER,0.001_DP,ERR,ERROR,*999)
!  CALL SOLVER_NEWTON_RELATIVE_TOLERANCE_SET(SOLVER,0.1_DP,ERR,ERROR,*999)
!  CALL SOLVER_NEWTON_MAXIMUM_FUNCTION_EVALUATIONS_SET(SOLVER,1000,ERR,ERROR,*999)
!  CALL SOLVER_NEWTON_MAXIMUM_ITERATIONS_SET(SOLVER,50,ERR,ERROR,*999)
  ...
  !CALL SOLVER_NEWTON_ABSOLUTE_TOLERANCE_SET(SOLVER,0.01_DP,ERR,ERROR,*999)
  !CALL SOLVER_NEWTON_LINESEARCH_TYPE_SET(SOLVER,SOLVER_NEWTON_LINESEARCH_QUADRATIC,ERR,ERROR,*999)
  CALL SOLVER_NEWTON_LINESEARCH_ALPHA_SET(SOLVER,0.000001_DP,ERR,ERROR,*999)
  !CALL SOLVER_NEWTON_TRUSTREGION_TOLERANCE_SET(SOLVER,0.0000000001_DP,ERR,ERROR,*999)
...
!  CALL SOLVER_LINEAR_ITERATIVE_ABSOLUTE_TOLERANCE_SET(LINEAR_SOLVER,0.001_DP,ERR,ERROR,*999)
!  CALL SOLVER_LINEAR_ITERATIVE_RELATIVE_TOLERANCE_SET(LINEAR_SOLVER,0.1_DP,ERR,ERROR,*999)
  !CALL SOLVER_LINEAR_ITERATIVE_DIVERGENCE_TOLERANCE_SET(LINEAR_SOLVER,100000.0_DP,ERR,ERROR,*999)
...
998 CALL CMISS_FINALISE(ERR,ERROR,*997)
997 STOP
