...
PROGRAM ANALYTIC_LINEAR_ELASTICITY_EXAMPLE
  ...
  CALL ANALYTIC_LINEAR_ELASTICITY_TESTCASE_EXPORT(NUMBER_GLOBAL_X_ELEMENTS,NUMBER_GLOBAL_Y_ELEMENTS,NUMBER_GLOBAL_Z_ELEMENTS,BASIS_LINEAR_LAGRANGE_INTERPOLATION,ERR,ERROR,*999)
...
999 CALL ERRORS("ANALYTIC_LINEAR_ELASTICITY_TESTCASE_EXPORT",ERR,ERROR)
  ...
  !  & ERR,ERROR,*)
    ...
    !DIAG_ROUTINE_LIST(1)="PROBLEM_SOLVE"
    DIAG_ROUTINE_LIST(1)="LINEAR_ELASTICITY_FINITE_ELEMENT_CALCULATE"
    ...
    CALL GENERATED_MESH_BASIS_SET(GENERATED_MESH,XYZ_BASES(1)%PTR,ERR,ERROR,*999)
    !Prescribe node coordinates
    l = 20.0_DP!/NUMBER_GLOBAL_X_ELEMENTS
	write(*,*) NUMBER_GLOBAL_X_ELEMENTS
    w = 20.0_DP!/NUMBER_GLOBAL_Y_ELEMENTS
	write(*,*) NUMBER_GLOBAL_Y_ELEMENTS
    h = 5.0_DP!0.036_DP!/NUMBER_GLOBAL_Z_ELEMENTS
	write(*,*) NUMBER_GLOBAL_Z_ELEMENTS

    !Define the mesh on the region
    CALL GENERATED_MESH_EXTENT_SET(GENERATED_MESH,(/l,w/),ERR,ERROR,*999)
    CALL GENERATED_MESH_NUMBER_OF_ELEMENTS_SET(GENERATED_MESH,(/NUMBER_GLOBAL_X_ELEMENTS, &
      & NUMBER_GLOBAL_Y_ELEMENTS/), ERR,ERROR,*999)
    ...
    DO FIELD_COMP_IDX=1,NUMBER_OF_FIELD_COMPS
      CALL FIELD_COMPONENT_VALUES_INITIALISE(MATERIAL_FIELD,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,FIELD_COMP_IDX,MATE_PARA(FIELD_COMP_IDX),ERR,ERROR,*999)
    ENDDO !FIELD_COMP_IDX
    ...
    NULLIFY(SOLVER) !Reuse Solver variable
