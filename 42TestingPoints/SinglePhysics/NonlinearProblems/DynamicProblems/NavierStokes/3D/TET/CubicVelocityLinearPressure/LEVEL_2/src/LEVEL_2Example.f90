!> \file
!> $Id: LEVEL_2Example.f90 1544 2010-09-23 09:38:31Z krittian $
...
!   TYPE(CMISSBoundaryConditionsType) :: BoundaryConditionsNavierStokes
  ...
  ! 4=CMISSEquationsSetStokesTwoDim4
  ! 5=CMISSEquationsSetStokesTwoDim5
  ! 1=CMISSEquationsSetStokesThreeDim1
  ! 2=CMISSEquationsSetStokesThreeDim2
  ! 3=CMISSEquationsSetStokesThreeDim3
  ! 4=CMISSEquationsSetStokesThreeDim4
  ! 5=CMISSEquationsSetStokesThreeDim5
...
!   READ(*,*) 
  ...
  IF(INPUT_TYPE==5.AND.NUMBER_OF_DIMENSIONS==2) THEN
    ANALYTICAL_TYPE=CMISSEquationsSetNavierStokesTwoDim5
  ELSE IF(INPUT_TYPE==5.AND.NUMBER_OF_DIMENSIONS==3) THEN
    ANALYTICAL_TYPE=CMISSEquationsSetNavierStokesThreeDim5
  ELSE
    !TODO more detailed error message
    WRITE(*,*)'INPUT ERROR!!!'
  ENDIF
