...
gfx modify spectrum phi linear reverse range 0.0 23.5 extend_above extend_below rainbow colour_range 0 1 component 1;
...
gfx modify g_element "/" node_points subgroup ExtracellularBidomainRegion coordinate Geometry LOCAL glyph sphere general size "0.05*0.05*0.05" centre 0,0,0 font default select_on material black selected_material default_selected;
...
gfx modify g_element "/" point as axes LOCAL glyph axes general size "1*1*1" centre 0,0,0 font default select_on material default selected_material default;

gfx create window 1 double_buffer;
gfx modify window 1 image scene default light_model default;
gfx modify window 1 image add_light default;
gfx modify window 1 layout 2d ortho_axes z -y eye_spacing 0.25 width 1060 height 548;
gfx modify window 1 set current_pane 1;
gfx modify window 1 background colour 1 1 1 texture none;
gfx modify window 1 view parallel eye_point 4 1 16.8214 interest_point 4 1 0 up_vector -0 1 -0 view_angle 25.6893 near_clipping_plane 0.168214 far_clipping_plane 60.114 relative_viewport ndc_placement -1 1 2 2 viewport_coordinates 0 0 1 1;
