...
SUBROUTINE CREATE_MESH(MESH_DATA,N_X,N_Y,N_Z,N_D,ERR,ERROR,*)
  ...
  CALL REGION_CREATE_START(1,MESH_DATA%REGION,ERR,ERROR,*999)
  ...
  CALL GENERATED_MESH_CREATE_FINISH(MESH_DATA%GENERATED_MESH,MESH_DATA%MESH,1,ERR,ERROR,*999) 
  ...
  CALL FIELD_CREATE_FINISH(MESH_DATA%REGION,MESH_DATA%GEOMETRIC_FIELD,ERR,ERROR,*999)

  !Update the geometric field parameters
  CALL GENERATED_MESHES_GEOMETRIC_PARAMETERS_CALCULATE(MESH_DATA%GEOMETRIC_FIELD,MESH_DATA%GENERATED_MESH,ERR,ERROR,*999)
