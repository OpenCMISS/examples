...
PROGRAM TWOREGIONSEXAMPLE
  ...
  NULLIFY(REGION1)
  CALL REGION_CREATE_START(1,REGION1,ERR,ERROR,*999)
  ...
  NULLIFY(REGION2)
  CALL REGION_CREATE_START(2,REGION2,ERR,ERROR,*999)
  !Set the regions coordinate system to the 2D RC coordinate system that we have created
  ...
  CALL GENERATED_MESH_CREATE_FINISH(GENERATED_MESH1,MESH1,1,ERR,ERROR,*999) 

  !Start the creation of a generated mesh in the region
  NULLIFY(GENERATED_MESH2)
  NULLIFY(MESH2)
  CALL GENERATED_MESH_CREATE_START(1,REGION2,GENERATED_MESH2,ERR,ERROR,*999)
  !Set up a regular mesh
  ...
  ENDIF    
  !Finish the creation of a generated mesh 
  CALL GENERATED_MESH_CREATE_FINISH(GENERATED_MESH2,MESH2,1,ERR,ERROR,*999) 
  ...
  CALL DECOMPOSITION_CREATE_FINISH(MESH1,DECOMPOSITION1,ERR,ERROR,*999)
  ...
  CALL DECOMPOSITION_CREATE_FINISH(MESH2,DECOMPOSITION2,ERR,ERROR,*999)
  ...
  CALL FIELD_CREATE_FINISH(REGION1,GEOMETRIC_FIELD1,ERR,ERROR,*999)
  ...
  ENDIF
  !Finish creating the field
  CALL FIELD_CREATE_FINISH(REGION2,GEOMETRIC_FIELD2,ERR,ERROR,*999)
       
  !Update the geometric field parameters
  CALL GENERATED_MESHES_GEOMETRIC_PARAMETERS_CALCULATE(GEOMETRIC_FIELD1,GENERATED_MESH1,ERR,ERROR,*999)
  !Update the geometric field parameters
  CALL GENERATED_MESHES_GEOMETRIC_PARAMETERS_CALCULATE(GEOMETRIC_FIELD2,GENERATED_MESH2,ERR,ERROR,*999)
