gfx read node CoupledStokes_1.part0.exnode 
gfx read element CoupledStokes_1.part0.exelem 
...
gfx read node CoupledStokes_2.part0.exnode
gfx read element CoupledStokes_2.part0.exelem
gfx define faces egroup Region2

gfx change_identifier no +100000
gfx change_identifier ele +100000

gfx read node CoupledStokes_Interface.part0.exnode
gfx read element CoupledStokes_Interface.part0.exelem
