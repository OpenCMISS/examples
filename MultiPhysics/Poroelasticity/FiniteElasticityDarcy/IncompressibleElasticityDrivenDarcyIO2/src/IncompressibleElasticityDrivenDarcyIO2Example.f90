...
!   BASIS_XI_INTERPOLATION_SOLID=CMFE_BASIS_LINEAR_LAGRANGE_INTERPOLATION
  ...
  DYNAMIC_SOLVER_DARCY_TIME_INCREMENT=1.0e-4_CMFEDP
  DYNAMIC_SOLVER_DARCY_STOP_TIME=100_CMFEIntg * DYNAMIC_SOLVER_DARCY_TIME_INCREMENT
...
!       VALUE = +1.0_CMFEDP  ! Mind the sign !
