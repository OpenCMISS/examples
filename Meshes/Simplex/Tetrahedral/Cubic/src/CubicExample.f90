...
!> \brief This is an example program to set up a generated mesh of cubic Simplex tetrahedra elements.
!>
!> \section LICENSE
!>
...
!> \example Meshes/Simplex/Tetrahedral/Cubic/src/CubicExample.f90
!! Example program to to set up a generated mesh of cubic Simplex tetrahedral elements.
!! \htmlinclude Meshes/Simplex/Tetrahedral/Cubic/history.html
!!
!<

!> Main program
PROGRAM CUBICTETRAHEDRASIMPLEXEXAMPLE
  ...
  CALL CMISSBasis_InterpolationXiSet(Basis,(/CMISS_BASIS_CUBIC_SIMPLEX_INTERPOLATION, &
    & CMISS_BASIS_CUBIC_SIMPLEX_INTERPOLATION,CMISS_BASIS_CUBIC_SIMPLEX_INTERPOLATION/),Err)
  ...
  CALL CMISSFields_NodesExport(Fields,"CubicTetrahedraSimplex","FORTRAN",Err)
  CALL CMISSFields_ElementsExport(Fields,"CubicTetrahedraSimplex","FORTRAN",Err)
...
END PROGRAM CUBICTETRAHEDRASIMPLEXEXAMPLE
