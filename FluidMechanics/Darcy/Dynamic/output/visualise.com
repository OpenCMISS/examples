...
gfx modify g_element OpenCMISS node_points glyph arrow_solid general size "0.3*0.3*0.3" centre 0,0,0 select_on material default selected_material default_selected data vec_mag orientation vector_field scale_factors "0.3*0.3*0.3" spectrum flow
