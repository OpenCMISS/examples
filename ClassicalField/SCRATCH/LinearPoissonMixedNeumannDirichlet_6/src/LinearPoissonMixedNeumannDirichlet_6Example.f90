...
!  REAL(CMISSDP), PARAMETER :: HEIGHT=1.0_CMISSDP/8.0_CMISSDP
!  REAL(CMISSDP), PARAMETER :: WIDTH=1.0_CMISSDP/8.0_CMISSDP
...
CALL CMISSEquationsSet_CreateStart(EquationsSetUserNumber,Region,GeometricField,CMISS_EQUATIONS_SET_CLASSICAL_FIELD_CLASS, &
  ...
  CALL CMISSEquationsSet_AnalyticCreateStart(EquationsSet,CMISS_TEST_CASE_MIXED_NEUMANN_DIRICHLET_6, &
