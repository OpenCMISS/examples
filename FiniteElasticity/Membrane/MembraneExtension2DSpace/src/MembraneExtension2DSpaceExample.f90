...
PROGRAM MEMBRANEEXTENSION2DSPACE
  ...
  INTEGER(CMFEIntg), PARAMETER :: FieldFibreNumberOfComponents=2
  ...
  CALL cmfe_Field_ComponentValuesInitialise(MaterialField,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,2,3.0_CMFEDP,Err)
  ...
  CALL cmfe_BoundaryConditions_SetNode(BoundaryConditions,DependentField,CMFE_FIELD_U_VARIABLE_TYPE,1,1,3,2, &
    & CMFE_BOUNDARY_CONDITION_FIXED,1.3_CMFEDP,Err)
