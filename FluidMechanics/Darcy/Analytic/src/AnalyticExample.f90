...
PROGRAM DARCYANALYTICEXAMPLE
  ...
  INTEGER(CMFEIntg), PARAMETER :: AnalyticFieldUserNumberDarcy=8
...
!   INTEGER(CMFEIntg) :: MPI_IERROR
  ...
  REAL(CMFEDP) :: DOMAIN_X1, DOMAIN_X2, DOMAIN_Y1, DOMAIN_Y2, DOMAIN_Z1, DOMAIN_Z2, DOMAIN_LENGTH
...
!   POROSITY_PARAM_DARCY=0.3_CMFEDP  !??? Also try with porosity unequal 1.0
  POROSITY_PARAM_DARCY=1.0_CMFEDP
  PERM_OVER_VIS_PARAM_DARCY=1.0_CMFEDP  !The value of 1.0 is also hard-coded as PERM_OVER_VIS_PARAM in DARCY_EQUATION_ANALYTIC_CALCULATE
...
CALL cmfe_EquationsSet_CreateStart(EquationsSetUserNumberDarcy,Region,GeometricField,[CMFE_EQUATIONS_SET_FLUID_MECHANICS_CLASS, &
  ...
  CALL cmfe_AnalyticAnalysisOutput(DependentFieldDarcy,OUTPUT_STRING,Err)
