...
!   INTEGER(CMFEIntg) :: CONDITION
  ...
  DYNAMIC_SOLVER_NAVIER_STOKES_STOP_TIME=0.03000001_CMFEDP
  DYNAMIC_SOLVER_NAVIER_STOKES_TIME_INCREMENT=0.010_CMFEDP
  ...
  ! 4=CMFE_EQUATIONS_SET_STOKES_EQUATION_TWO_DIM_4
  ! 5=CMFE_EQUATIONS_SET_STOKES_EQUATION_TWO_DIM_5
  ! 1=CMFE_EQUATIONS_SET_STOKES_EQUATION_THREE_DIM_1
  ! 2=CMFE_EQUATIONS_SET_STOKES_EQUATION_THREE_DIM_2
  ! 3=CMFE_EQUATIONS_SET_STOKES_EQUATION_THREE_DIM_3
  ! 4=CMFE_EQUATIONS_SET_STOKES_EQUATION_THREE_DIM_4
  ! 5=CMFE_EQUATIONS_SET_STOKES_EQUATION_THREE_DIM_5
...
!   READ(*,*) 
  ...
  IF(INPUT_TYPE==5.AND.NUMBER_OF_DIMENSIONS==2) THEN
    ANALYTICAL_TYPE=CMFE_EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_5
  ELSE IF(INPUT_TYPE==5.AND.NUMBER_OF_DIMENSIONS==3) THEN
    ANALYTICAL_TYPE=CMFE_EQUATIONS_SET_NAVIER_STOKES_EQUATION_THREE_DIM_5
  ELSE
    !TODO more detailed error message
    WRITE(*,*)'INPUT ERROR!!!'
  ENDIF
