...
!   INTEGER(CMISSIntg) :: MPI_IERROR
  ...
  CALL CMISSEquationsSet_CreateStart(EquationsSetUserNumberStokes,Region,GeometricField,CMISS_EQUATIONS_SET_FLUID_MECHANICS_CLASS,&
    & CMISS_EQUATIONS_SET_STOKES_EQUATION_TYPE,CMISS_EQUATIONS_SET_ALE_STOKES_SUBTYPE,&
...
!   CALL CMISSEquationsSet_SpecificationSet(EquationsSetStokes,CMISS_EQUATIONS_SET_FLUID_MECHANICS_CLASS, &
!     & CMISS_EQUATIONS_SET_STOKES_EQUATION_TYPE,CMISS_EQUATIONS_SET_ALE_STOKES_SUBTYPE,Err)
...
!   CALL CMISSSolverDynamicALESet(DynamicSolverStokes,.TRUE.,Err)
  ...
  IF(EXPORT_FIELD_IO) THEN
    ...
    CALL CMISSFields_NodesExport(Fields,"ALEStokes","FORTRAN",Err)
    CALL CMISSFields_ElementsExport(Fields,"ALEStokes","FORTRAN",Err)
