PROGRAM FINITEELASTICITYEXAMPLE
  ...
  TYPE(FIELD_TYPE), POINTER :: undeffield,fibrefield,materialfield,deffield,boundaryfield,gggg  
  TYPE(EQUATIONS_SET_TYPE), POINTER :: equations,eeee
  TYPE(PROBLEM_TYPE), POINTER :: problem
  TYPE(SOLVER_TYPE), POINTER :: solver
  TYPE(FIELD_INTERPOLATED_POINT_METRICS_TYPE), POINTER :: ssss  
...
!******
  ...
  CALL GENERATED_MESHES_GEOMETRIC_PARAMETERS_CALCULATE(undeffield,GENERATED_MESH,ERR,ERROR,*999)
!******
...
!******
  ...
  CALL FIELD_TYPE_SET(5,region1,3,ERR,ERROR,*999)
...
!******
  CALL EQUATIONS_SET_CREATE_START(1,region1,undeffield,equations,ERR,ERROR,*999)
  CALL EQUATIONS_SET_SPECIFICATION_SET(equations,EQUATIONS_SET_ELASTICITY_CLASS, &
    & EQUATIONS_SET_FINITE_ELASTICITY_TYPE,EQUATIONS_SET_NO_SUBTYPE,ERR,ERROR,*999)
  CALL EQUATIONS_SET_CREATE_FINISH(equations,ERR,ERROR,*999)
  CALL EQUATIONS_SET_DEPENDENT_CREATE_START(equations,ERR,ERROR,*999)
  CALL EQUATIONS_SET_DEPENDENT_CREATE_FINISH(equations,ERR,ERROR,*999)
!******

  CALL EQUATIONS_SET_MATERIALS_CREATE_START(equations,ERR,ERROR,*999)
  CALL EQUATIONS_SET_MATERIALS_CREATE_FINISH(equations,ERR,ERROR,*999)
...
!    gggg=>equations%INTERPOLATION%GEOMETRIC_FIELD
