...
!   TYPE(cmfe_EquationsSetType) :: EquationsSetDarcy
  ...
  INTEGER(CMFEIntg), ALLOCATABLE :: EquationsSetIndices(:)
  ...
  INTEGER(CMFEIntg) :: EquationsSetFieldDarcyUserNumber
  INTEGER(CMFEIntg) :: EquationsSetUserNumberDarcy
  INTEGER(CMFEIntg) :: icomp,Ncompartments,num_var,icompartment
...
!   CALL cmfe_DiagnosticsSetOn(CMFE_IN_DIAG_TYPE,DIAG_LEVEL_LIST,"DarcyDiagnostics",DIAG_ROUTINE_LIST,Err)
  ...
  DO icomp = 1,Ncompartments
    EquationsSetFieldDarcyUserNumber = 100_CMFEIntg + icomp
    EquationsSetUserNumberDarcy = 200_CMFEIntg + icomp
