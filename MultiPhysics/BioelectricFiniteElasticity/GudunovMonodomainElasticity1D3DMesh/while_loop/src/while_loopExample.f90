...
! these time steps work with     STIM_VALUE=8000.0_CMISSDP
!  REAL(CMISSDP), PARAMETER :: ELASTICITY_TIME_STEP=0.010000000001_CMISSDP!0.5_CMISSDP!0.05_CMISSDP!0.8_CMISSDP
!  REAL(CMISSDP), PARAMETER :: STIM_STOP=0.01_CMISSDP!ELASTICITY_TIME_STEP
  ...
  REAL(CMISSDP), PARAMETER :: Vmax=-0.02_CMISSDP ! 0.02 cm/ms = 0.2 m/s, rat GM    ! this is how it was!!!
!  REAL(CMISSDP), PARAMETER :: Vmax=-0.2_CMISSDP !this value is 10 times too large, which stabilizes the problem !TODO
  
  !CAUTION - what are the units???
  REAL(CMISSDP), PARAMETER, DIMENSION(4) :: MAT_FE= &
!    & [-0.006904519351291_CMISSDP,0.0286165087536_CMISSDP,0.914983651640659_CMISSDP,9.443328279782643_CMISSDP] !original values EKIN
!    & [-6.904519351291_CMISSDP,28.6165087536_CMISSDP,914.983651640659_CMISSDP,9.443328279782643_CMISSDP]
!    & [-0.048010319216141_CMISSDP,0.067407738257482_CMISSDP,0.917752338185330_CMISSDP,9.438822344231113_CMISSDP] !original values TOMO [N/cm^2]
!    & [-0.356463872119506_CMISSDP,3.859558638795475_CMISSDP,0.000035686432282_CMISSDP,42.620401658342743_CMISSDP] !new values TOMO [kPa]
!    & [-0.0356463872119506_CMISSDP,0.3859558638795475_CMISSDP,0.0000035686432282_CMISSDP,42.620401658342743_CMISSDP] !new values TOMO [N/cm^2]
    & [0.0000000000635201_CMISSDP,0.3626712895523322_CMISSDP,0.0000027562837093_CMISSDP,43.372873938671383_CMISSDP] !new values TOMO [N/cm^2]
  ...
  INTEGER(CMISSIntg) :: NodeNumber,node_idx,NodeDomain,NumberOfDomains,ComponentNumber,domain_idx,ElementDomain
  INTEGER(CMISSIntg) :: NumberOfNodesInXi1,NumberOfNodesInXi2,NumberOfNodesInXi3
  INTEGER(CMISSIntg) :: i,j,k,my_node_idx,elem_idx,node1,node2,elem_idx2
...
!  REAL(CMISSDP) :: YVALUE
  ...
  TYPE(CMISSControlLoopType) :: ControlLoopMain,ControlLoopM,ControlLoopFE
  ...
  TYPE(CMISSSolverType) :: SolverDAE,SolverParabolic,SolverFE,LinearSolverFE
  TYPE(CMISSSolverEquationsType) :: SolverEquationsM,SolverEquationsFE
  TYPE(CMISSNodesType) :: Nodes
  TYPE(CMISSMeshElementsType) :: QuadraticElements,LinearElements,ElementsM
...
!      DO elem_idx=1,NumberOfElementsFE/NumberOfDomains/2
  ...
  CALL CMISSField_NumberOfVariablesSet(GeometricFieldFE,1,Err)
  CALL CMISSField_NumberOfComponentsSet(GeometricFieldFE,CMISS_FIELD_U_VARIABLE_TYPE,3,Err)  
...
!  CALL CMISSField_ParameterSetUpdateFinish(GeometricFieldFE,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE,Err)
  ...
  CALL CMISSField_NumberOfVariablesSet(FibreField,1,Err)
  CALL CMISSField_NumberOfComponentsSet(FibreField,CMISS_FIELD_U_VARIABLE_TYPE,3,Err)  
  ...
  CALL CMISSField_NumberOfVariablesSet(MaterialFieldFE,2,Err)
  CALL CMISSField_VariableTypesSet(MaterialFieldFE,[CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_V_VARIABLE_TYPE],Err)
  CALL CMISSField_NumberOfComponentsSet(MaterialFieldFE,CMISS_FIELD_U_VARIABLE_TYPE,5,Err)
  CALL CMISSField_NumberOfComponentsSet(MaterialFieldFE,CMISS_FIELD_V_VARIABLE_TYPE,1,Err)
...
!  CALL CMISSField_ComponentValuesInitialise(MaterialFieldFE,CMISS_FIELD_V_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE,1,0.0_CMISSDP,Err)
  ...
  !Create the dependent field for FE with 2 variables and 4 components 
  ...
  CALL CMISSField_NumberOfVariablesSet(DependentFieldFE,2,Err)
  CALL CMISSField_VariableTypesSet(DependentFieldFE,[CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_DELUDELN_VARIABLE_TYPE],Err)
  CALL CMISSField_NumberOfComponentsSet(DependentFieldFE,CMISS_FIELD_U_VARIABLE_TYPE,4,Err)
  CALL CMISSField_NumberOfComponentsSet(DependentFieldFE,CMISS_FIELD_DELUDELN_VARIABLE_TYPE,4,Err)
...
!  independent_field_auto_create = .TRUE.
  ...
  IF(.NOT. independent_field_auto_create) THEN
    ...
    CALL CMISSField_NumberOfVariablesSet(IndependentFieldFE,3,Err)
    CALL CMISSField_VariableTypesSet(IndependentFieldFE,[CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_V_VARIABLE_TYPE, &
      & CMISS_FIELD_U1_VARIABLE_TYPE],Err)

    CALL CMISSField_DimensionSet(IndependentFieldFE,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_SCALAR_DIMENSION_TYPE,Err)
    CALL CMISSField_NumberOfComponentsSet(IndependentFieldFE,CMISS_FIELD_U_VARIABLE_TYPE,1,Err)
    CALL CMISSField_ComponentInterpolationSet(IndependentFieldFE,CMISS_FIELD_U_VARIABLE_TYPE,1, &
     & CMISS_FIELD_GAUSS_POINT_BASED_INTERPOLATION,Err) !active stress
    ...
    CALL CMISSField_NumberOfComponentsSet(IndependentFieldFE,CMISS_FIELD_U1_VARIABLE_TYPE,3,Err)
    CALL CMISSField_ComponentInterpolationSet(IndependentFieldFE,CMISS_FIELD_U1_VARIABLE_TYPE,1, &
     & CMISS_FIELD_GAUSS_POINT_BASED_INTERPOLATION,Err) !fibre stretch (2 parameter sets)
    CALL CMISSField_ComponentInterpolationSet(IndependentFieldFE,CMISS_FIELD_U1_VARIABLE_TYPE,2, &
     & CMISS_FIELD_CONSTANT_INTERPOLATION,Err) !initial half-sarcomere length
    CALL CMISSField_ComponentInterpolationSet(IndependentFieldFE,CMISS_FIELD_U1_VARIABLE_TYPE,3, &
     & CMISS_FIELD_CONSTANT_INTERPOLATION,Err) !max contraction velo
    CALL CMISSField_ComponentMeshComponentSet(IndependentFieldFE,CMISS_FIELD_U1_VARIABLE_TYPE,1,QuadraticMeshComponentNumber,Err)
    CALL CMISSField_ComponentMeshComponentSet(IndependentFieldFE,CMISS_FIELD_U1_VARIABLE_TYPE,2,QuadraticMeshComponentNumber,Err)
    CALL CMISSField_ComponentMeshComponentSet(IndependentFieldFE,CMISS_FIELD_U1_VARIABLE_TYPE,3,QuadraticMeshComponentNumber,Err)
    CALL CMISSField_DataTypeSet(IndependentFieldFE,CMISS_FIELD_U1_VARIABLE_TYPE,CMISS_FIELD_DP_TYPE,Err)
    CALL CMISSField_VariableLabelSet(IndependentFieldFE,CMISS_FIELD_U1_VARIABLE_TYPE,"fibreStretch_FE",Err)
  ...
  CALL CMISSField_ComponentValuesInitialise(IndependentFieldFE,CMISS_FIELD_U1_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE,1, &
   & 1.0_CMISSDP,Err) !fibre stretch
  CALL CMISSField_ComponentValuesInitialise(IndependentFieldFE,CMISS_FIELD_U1_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE,2, &
   & 1.0_CMISSDP,Err) !initial half-sarcomere length
  CALL CMISSField_ComponentValuesInitialise(IndependentFieldFE,CMISS_FIELD_U1_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE,3, &
...
!   & Vmax/(NumberOfInSeriesFibres*NumberOfNodesPerFibre-1),Err)
  ...
  CALL CMISSField_NumberOfVariablesSet(MaterialFieldM,1,Err)
  CALL CMISSField_NumberOfComponentsSet(MaterialFieldM,CMISS_FIELD_U_VARIABLE_TYPE,3,Err)
  ...
  CALL CMISSField_NumberOfVariablesSet(DependentFieldM,3,Err)
  ...
  CALL CMISSField_NumberOfComponentsSet(DependentFieldM,CMISS_FIELD_U_VARIABLE_TYPE,1,Err)
  CALL CMISSField_NumberOfComponentsSet(DependentFieldM,CMISS_FIELD_DELUDELN_VARIABLE_TYPE,1,Err)
...
!  independent_field_auto_create = .TRUE.
  ...
  IF(.NOT. independent_field_auto_create) THEN
    ...
    CALL CMISSField_NumberOfVariablesSet(IndependentFieldM,2,Err)
    CALL CMISSField_VariableTypesSet(IndependentFieldM,[CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_V_VARIABLE_TYPE],Err)
    
    !first variable:   CMISS_FIELD_U_VARIABLE_TYPE -- 1) active stress
    CALL CMISSField_DataTypeSet(IndependentFieldM,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_DP_TYPE,Err)
    CALL CMISSField_DimensionSet(IndependentFieldM,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_SCALAR_DIMENSION_TYPE,Err)
    ...
    CALL CMISSField_NumberOfComponentsSet(IndependentFieldM,CMISS_FIELD_V_VARIABLE_TYPE,5,Err)
  ...
  CALL CMISSEquationsSet_CreateStart(EquationsSetsUserNumberFE,RegionFE,FibreField,CMISS_EQUATIONS_SET_ELASTICITY_CLASS, &
   & CMISS_EQUATIONS_SET_FINITE_ELASTICITY_TYPE,CMISS_EQUATIONS_SET_MONODOMAIN_ELASTICITY_VELOCITY_SUBTYPE, & 
  ...
  !need to do this here, as the parameter set is only created just above
  CALL CMISSField_ComponentValuesInitialise(IndependentFieldFE,CMISS_FIELD_U1_VARIABLE_TYPE,CMISS_FIELD_PREVIOUS_VALUES_SET_TYPE, &
   & 1,1.0_CMISSDP,Err) !fibre stretch of previous step
  ...
  CALL CMISSEquationsSet_CreateStart(EquationsSetsUserNumberM,RegionM,GeometricFieldM,CMISS_EQUATIONS_SET_BIOELECTRICS_CLASS, &
   & CMISS_EQUATIONS_SET_MONODOMAIN_EQUATION_TYPE,CMISS_EQUATIONS_SET_MONODOMAIN_ELASTICITY_VELOCITY_SUBTYPE, &
...
!   & -8.0_CMISSDP,Err)
  ...
  CALL CMISSField_ParametersToFieldParametersComponentCopy(DependentFieldFE,CMISS_FIELD_U_VARIABLE_TYPE, &
    & CMISS_FIELD_VALUES_SET_TYPE,1,DependentFieldFE,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_PREVIOUS_VALUES_SET_TYPE,1,err)
  CALL CMISSField_ParametersToFieldParametersComponentCopy(DependentFieldFE,CMISS_FIELD_U_VARIABLE_TYPE, &
    & CMISS_FIELD_VALUES_SET_TYPE,2,DependentFieldFE,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_PREVIOUS_VALUES_SET_TYPE,2,err)
  CALL CMISSField_ParametersToFieldParametersComponentCopy(DependentFieldFE,CMISS_FIELD_U_VARIABLE_TYPE, &
    & CMISS_FIELD_VALUES_SET_TYPE,3,DependentFieldFE,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_PREVIOUS_VALUES_SET_TYPE,3,err)
...
!  CALL CMISSField_ParameterSetUpdateFinish(CellMLModelsField,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE,Err)
  ...
  CALL CMISSProblem_SpecificationSet(Problem,CMISS_PROBLEM_MULTI_PHYSICS_CLASS,CMISS_PROBLEM_BIOELECTRIC_FINITE_ELASTICITY_TYPE, &
   & CMISS_PROBLEM_MONODOMAIN_ELASTICITY_VELOCITY_SUBTYPE,Err)
  ...
  CALL CMISSControlLoop_TypeSet(ControlLoopFE,CMISS_PROBLEM_CONTROL_WHILE_LOOP_TYPE,Err)
  CALL CMISSControlLoop_MaximumIterationsSet(ControlLoopFE,100,Err) !20
  ...
  CALL CMISSSolver_NewtonMaximumIterationsSet(SolverFE,1000,Err)
...
!        & CMISS_BOUNDARY_CONDITION_FIXED_USER_CONTROLLED,0.0_CMISSDP,Err)
!        & CMISS_BOUNDARY_CONDITION_FIXED,0.0_CMISSDP,Err)
        & CMISS_BOUNDARY_CONDITION_FIXED_INCREMENTED,0.0_CMISSDP,Err)
    ENDIF
  ENDDO
  ...
  DO node_idx=1,SIZE(RightSurfaceNodes,1)
    ...
    IF(NodeDomain==ComputationalNodeNumber) THEN
      CALL CMISSBoundaryConditions_SetNode(BoundaryConditionsFE,DependentFieldFE,CMISS_FIELD_U_VARIABLE_TYPE,1,1,NodeNumber,1, &
!        & CMISS_BOUNDARY_CONDITION_FIXED_INCREMENTED,LENGTH*1.2_CMISSDP,Err)
!        & CMISS_BOUNDARY_CONDITION_FIXED_INCREMENTED,LENGTH*1.05_CMISSDP,Err)
        & CMISS_BOUNDARY_CONDITION_FIXED_INCREMENTED,LENGTH*1.0_CMISSDP,Err)
    ENDIF
  ENDDO
...
!########################
!!!!prestretch the tissue some more
!!!  DO node_idx=1,SIZE(RightSurfaceNodes,1)
!!!    NodeNumber=RightSurfaceNodes(node_idx)
!!!    CALL CMISSDecomposition_NodeDomainGet(DecompositionFE,NodeNumber,1,NodeDomain,Err)
!!!    IF(NodeDomain==ComputationalNodeNumber) THEN
!!!      CALL CMISSBoundaryConditions_SetNode(BoundaryConditionsFE,DependentFieldFE,CMISS_FIELD_U_VARIABLE_TYPE,1,1,NodeNumber,1, &
!!!!        & CMISS_BOUNDARY_CONDITION_FIXED_INCREMENTED,LENGTH*1.2_CMISSDP,Err)
!!!        & CMISS_BOUNDARY_CONDITION_FIXED_INCREMENTED,LENGTH*1.1_CMISSDP,Err)
!!!    ENDIF
!!!  ENDDO
...
!!!      CALL CMISSBoundaryConditions_SetNode(BoundaryConditionsFE,DependentFieldFE,CMISS_FIELD_U_VARIABLE_TYPE,1,1,NodeNumber,1, &
!!!!        & CMISS_BOUNDARY_CONDITION_FIXED_INCREMENTED,LENGTH*1.2_CMISSDP,Err)
!!!        & CMISS_BOUNDARY_CONDITION_FIXED_INCREMENTED,LENGTH*1.15_CMISSDP,Err)
!!!    ENDIF
!!!  ENDDO
...
!!  VALUE = VALUE+ABS(Vmax)/10.0_CMISSDP*STIM_STOP
!  CALL CMISSControlLoop_BoundaryConditionUpdate(ControlLoopFE,1,1,VALUE,Err)
  DO node_idx=1,SIZE(LeftSurfaceNodes,1)
    NodeNumber=LeftSurfaceNodes(node_idx)
    CALL CMISSDecomposition_NodeDomainGet(DecompositionFE,NodeNumber,1,NodeDomain,Err)
    IF(NodeDomain==ComputationalNodeNumber) THEN
