...
!> \example FluidMechanics/Stokes/HexChannel/src/HexChannelExample.f90
!! Example program to solve a Stokes equation using openCMISS calls.
!! \par Latest Builds:
!! \li <a href='http://autotest.bioeng.auckland.ac.nz/opencmiss-build/logs_x86_64-linux/FluidMechanics/Stokes/HexChannel/build-intel'>Linux Intel Build</a>
!! \li <a href='http://autotest.bioeng.auckland.ac.nz/opencmiss-build/logs_x86_64-linux/FluidMechanics/Stokes/HexChannel/build-gnu'>Linux GNU Build</a>
!<
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  &FIELD_VALUES_SET_TYPE,1,1000.0_DP,ERR,ERROR,*999)
   CALL FIELD_COMPONENT_VALUES_INITIALISE(MATERIALS_FIELD,FIELD_U_VARIABLE_TYPE,&
   &FIELD_VALUES_SET_TYPE,2,1000.0_DP,ERR,ERROR,*999)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  DO I=1,CM%D
    DO J=1,BC_NUMBER_OF_INLET_NODES
       ...
       IF(I==1) THEN !U
       DOF_VALUES(CM%D*BC_NUMBER_OF_WALL_NODES+J+((I-1)*BC_NUMBER_OF_INLET_NODES))=0.1_DP
       ELSE IF(I==2) THEN!V
