...
!...................................................................................
  ...
  INTEGER(CMFEIntg) :: I,J,K,ELEMENT_NUMBER,MIN_TRIAL_NODE,TRIAL_STATUS,CHANGED_STATUS,SEED_POINT,TOTAL_NUMBER_OF_CONNECTIVITY
  INTEGER(CMFEIntg) :: NUMBER_OF_NODES_PER_ELEMENT,TOTAL_NUMBER_OF_NODES,TOTAL_NUMBER_OF_ELEMENTS
  INTEGER(CMFEIntg) :: NUMBER_OF_SNAPSHOTS
  REAL(CMFEDP) :: MIN_VALUE,MAX_VALUE,TIME_STEP
  REAL(CMFEDP) :: SPEED_FUNCTION_ALONG_EIGEN_VECTOR(3)
  ...
  REAL(CMFEDP), ALLOCATABLE, DIMENSION(:,:):: NODE_LIST
  REAL(CMFEDP), ALLOCATABLE, DIMENSION(:,:):: SPEED_FUNCTION_TABLE
  REAL(CMFEDP), ALLOCATABLE, DIMENSION(:,:):: CONDUCTIVITY_TENSOR
  REAL(CMFEDP), ALLOCATABLE, DIMENSION(:,:):: SPEED_FUNCTION_TABLE_ON_CONNECTIVITY
  REAL(CMFEDP), ALLOCATABLE, DIMENSION(:,:):: CONDUCTIVITY_TENSOR_ON_CONNECTIVITY
  REAL(CMFEDP), ALLOCATABLE, DIMENSION(:)  :: SEED_VALUE
  REAL(CMFEDP), ALLOCATABLE, DIMENSION(:)  :: SNAPSHOT_SEED_VALUE
  REAL(CMFEDP), ALLOCATABLE, DIMENSION(:)  :: RELATIVE_ERROR
  REAL(CMFEDP), ALLOCATABLE, DIMENSION(:)  :: SEED_VALUE_EXACT_SOLUTION
  REAL(CMFEDP), ALLOCATABLE, DIMENSION(:)  :: TRACE_NODES
  
  INTEGER(CMFEIntg), ALLOCATABLE, DIMENSION(:,:):: CONNECTIVITY_LIST
  INTEGER(CMFEIntg), ALLOCATABLE, DIMENSION(:,:):: ELEMENT_LIST
  INTEGER(CMFEIntg), ALLOCATABLE, DIMENSION(:)  :: CONNECTIVITY_NUMBER
  INTEGER(CMFEIntg), ALLOCATABLE, DIMENSION(:)  :: TRACE_NODE

  INTEGER(CMFEIntg), ALLOCATABLE, DIMENSION(:)  :: COLUMN_INDEX
  INTEGER(CMFEIntg), ALLOCATABLE, DIMENSION(:)  :: TEMP_ARRAY
  INTEGER(CMFEIntg), ALLOCATABLE, DIMENSION(:)  :: RAW_INDEX
...
!		                      "LIST"  -> refers to NODAL LIST below
  INPUT_TYPE_FOR_SEED_VALUE = "LIST"
    ...
    SEED_VALUE(SEED_POINT)=0.0_CMFEDP
...
!		                          "FIXED"  -> refers to constant values below
  INPUT_TYPE_FOR_SPEED_FUNCTION = "FIXED" 
    ...
    ! EIGEN-VECTOR 1
    SPEED_FUNCTION_ALONG_EIGEN_VECTOR(1) = 10.0_CMFEDP

    ! EIGEN-VECTOR 2
    SPEED_FUNCTION_ALONG_EIGEN_VECTOR(2) = 1.0_CMFEDP

    ! EIGEN-VECTOR 3
    SPEED_FUNCTION_ALONG_EIGEN_VECTOR(3) = 1.0_CMFEDP
