...
!   INTEGER(CMFEIntg) :: CONDITION
  ...
  DYNAMIC_SOLVER_NAVIER_STOKES_STOP_TIME=1.001_CMFEDP 
  DYNAMIC_SOLVER_NAVIER_STOKES_TIME_INCREMENT=0.100_CMFEDP
  DYNAMIC_SOLVER_NAVIER_STOKES_THETA=1.0_CMFEDP/1.0_CMFEDP
  !Set result output parameter
  DYNAMIC_SOLVER_NAVIER_STOKES_OUTPUT_FREQUENCY=1
  !Set solver parameters
  LINEAR_SOLVER_NAVIER_STOKES_DIRECT_FLAG=.TRUE.
  RELATIVE_TOLERANCE=1.0E-8_CMFEDP !default: 1.0E-05_CMFEDP
...
! ! !   ENDIF
  ...
  IF(INPUT_TYPE==4.AND.NUMBER_OF_DIMENSIONS==2) ANALYTICAL_TYPE=CMFE_EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_4
  IF(INPUT_TYPE==5.AND.NUMBER_OF_DIMENSIONS==2) ANALYTICAL_TYPE=CMFE_EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_5
  ...
  IF(INPUT_TYPE==3.AND.NUMBER_OF_DIMENSIONS==3) ANALYTICAL_TYPE=CMFE_EQUATIONS_SET_NAVIER_STOKES_EQUATION_THREE_DIM_3
  ...
  ELSE
    ...
    !Set the basis type (Lagrange/Simplex)LinearSolverNavierStokes
  ...
  DO NODE_NUMBER=1,NUMBER_OF_NODES_SPACE
    DO COMPONENT_NUMBER=1,NUMBER_OF_DIMENSIONS
      VALUE=CM%N(NODE_NUMBER,COMPONENT_NUMBER)*0.3141592653589793_CMFEDP
