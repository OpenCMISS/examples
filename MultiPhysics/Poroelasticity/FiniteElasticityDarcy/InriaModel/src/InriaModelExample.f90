...
PROGRAM FINITEELASTICITYDARCYEXAMPLE
  ...
  REAL(CMFEDP) :: INITIAL_FIELD_DARCY(5)
...
! 
  ...
  INTEGER(CMFEIntg), PARAMETER :: FieldMaterialSolidNumberOfComponents=3 !2
! 
  ...
  INTEGER(CMFEIntg), PARAMETER :: FieldDependentSolidNumberOfComponents=3 !4
  INTEGER(CMFEIntg), PARAMETER :: FieldDependentFluidNumberOfComponents=5  !(u,v,w,p,m)
! 
  ...
  DOMAIN_Z1 = -10.0_CMFEDP
  DOMAIN_Z2 =  10.0_CMFEDP
  ...
  INITIAL_FIELD_DARCY(5)=0.0_CMFEDP
...
!   DYNAMIC_SOLVER_DARCY_STOP_TIME=0.03_CMFEDP
  DYNAMIC_SOLVER_DARCY_TIME_INCREMENT=5.0e-4_CMFEDP
...
!---
  ...
  CALL cmfe_EquationsSet_CreateStart(EquationsSetUserNumberDarcy,Region,GeometricField,[CMFE_EQUATIONS_SET_FLUID_MECHANICS_CLASS, &
    & CMFE_EQUATIONS_SET_DARCY_EQUATION_TYPE,CMFE_EQUATIONS_SET_ELASTICITY_DARCY_INRIA_MODEL_SUBTYPE], &
    & EquationsSetFieldUserNumberDarcy,EquationsSetFieldDarcy,EquationsSetDarcy,Err)

!   CALL cmfe_EquationsSet_CreateStart(EquationsSetUserNumberDarcy,Region,GeometricField,[EquationsSetDarcy,Err])
...
! !     & CMFE_EQUATIONS_SET_DARCY_EQUATION_TYPE,CMFE_EQUATIONS_SET_INCOMPRESS_FINITE_ELASTICITY_DARCY_SUBTYPE,Err)
!     & CMFE_EQUATIONS_SET_DARCY_EQUATION_TYPE,CMFE_EQUATIONS_SET_ELASTICITY_DARCY_INRIA_MODEL_SUBTYPE,Err)
...
!   CALL cmfe_EquationsSet_CreateStart(EquationsSetUserNumberMatProperties,Region,GeometricField,[EquationsSetMatProperties,Err])
...
!     & CMFE_EQUATIONS_SET_DATA_FITTING_EQUATION_TYPE,CMFE_EQUATIONS_SET_MAT_PROP_INRIA_MODEL_DATA_FITTING_SUBTYPE,Err)
  ...
  CALL cmfe_EquationsSet_CreateStart(EquationSetSolidUserNumber,Region,FibreFieldSolid,[CMFE_EQUATIONS_SET_ELASTICITY_CLASS, &
    & CMFE_EQUATIONS_SET_FINITE_ELASTICITY_TYPE,CMFE_EQUATIONS_SET_ELASTICITY_DARCY_INRIA_MODEL_SUBTYPE], &
    & EquationsSetFieldSolidUserNumber,EquationsSetFieldSolid,EquationsSetSolid,Err)

!   CALL cmfe_EquationsSet_CreateStart(EquationSetSolidUserNumber,Region,FibreFieldSolid,[EquationsSetSolid,Err])
...
! !     & CMFE_EQUATIONS_SET_FINITE_ELASTICITY_TYPE,CMFE_EQUATIONS_SET_COMPRESSIBLE_FINITE_ELASTICITY_SUBTYPE,Err)
! !     & CMFE_EQUATIONS_SET_FINITE_ELASTICITY_TYPE,CMFE_EQUATIONS_SET_INCOMPRESS_FINITE_ELASTICITY_DARCY_SUBTYPE,Err)
!     & CMFE_EQUATIONS_SET_FINITE_ELASTICITY_TYPE,CMFE_EQUATIONS_SET_ELASTICITY_DARCY_INRIA_MODEL_SUBTYPE,Err)
  ...
  CALL cmfe_Field_ComponentMeshComponentSet(MaterialFieldSolid,CMFE_FIELD_U_VARIABLE_TYPE,3,SolidMeshComponenetNumber,Err)
  !
  CALL cmfe_Field_CreateFinish(MaterialFieldSolid,Err)

  !Set material parameters
!   CALL cmfe_Field_ComponentValuesInitialise(MaterialFieldSolid,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,1,1.0_CMFEDP,Err)
  CALL cmfe_Field_ComponentValuesInitialise(MaterialFieldSolid,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,1, &
    & 2.0e3_CMFEDP,Err)
!   CALL cmfe_Field_ComponentValuesInitialise(MaterialFieldSolid,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,2,1.0_CMFEDP,Err)
  CALL cmfe_Field_ComponentValuesInitialise(MaterialFieldSolid,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,2, &
    & 33.0_CMFEDP,Err)
!   CALL cmfe_Field_ComponentValuesInitialise(MaterialFieldSolid,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,3,1.0e7_CMFEDP,Err)
...
!   CALL cmfe_Field_ComponentMeshComponentSet(DependentFieldSolid,CMFE_FIELD_DELUDELN_VARIABLE_TYPE,4,SolidMeshComponenetNumber,Err)
  ...
  CALL cmfe_Field_ComponentMeshComponentSet(DependentFieldSolid,CMFE_FIELD_V_VARIABLE_TYPE,5,MESH_COMPONENT_NUMBER_PRESSURE,Err)  
  ...
  CALL cmfe_Field_ComponentMeshComponentSet(DependentFieldSolid,CMFE_FIELD_DELVDELN_VARIABLE_TYPE,5, &
    & MESH_COMPONENT_NUMBER_PRESSURE,Err)
...
!   CALL cmfe_Field_ComponentValuesInitialise(DependentFieldSolid,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,4,-8.0_CMFEDP,Err)
  ...
  IF( CM%D==2_CMFEIntg ) THEN !CM%D = number of dimensions, ie 2D
    DO NODE_NUMBER=1_CMFEIntg,NUMBER_OF_NODES_GEOMETRY
      ...
      IF( (ABS(COORD_X-DOMAIN_X1) < GEOMETRY_TOLERANCE) ) THEN
        !x-velocity
        VALUE = 1.0_CMFEDP
        CALL cmfe_BoundaryConditions_SetNode(BoundaryConditionsDarcy,DependentFieldSolid,CMFE_FIELD_V_VARIABLE_TYPE,1, &
          & CMFE_NO_GLOBAL_DERIV,NODE_NUMBER,1_CMFEIntg,CONDITION,VALUE,Err)
      END IF
      !
      ...
      IF( (ABS(COORD_Y-DOMAIN_Y1) < GEOMETRY_TOLERANCE) ) THEN
        ...
        VALUE = 2.0_CMFEDP
        CALL cmfe_BoundaryConditions_SetNode(BoundaryConditionsDarcy,DependentFieldSolid,CMFE_FIELD_V_VARIABLE_TYPE,1, &
          & CMFE_NO_GLOBAL_DERIV,NODE_NUMBER,2_CMFEIntg,CONDITION,VALUE,Err)
      END IF
      !
...
!         VALUE = COORD_X
!         CALL cmfe_BoundaryConditions_SetNode(BoundaryConditionsSolid,DependentFieldSolid,CMFE_FIELD_U_VARIABLE_TYPE,1,CMFE_NO_GLOBAL_DERIV, &
...
!           & NODE_NUMBER,1_CMFEIntg,CMFE_BOUNDARY_CONDITION_FIXED,VALUE,Err)
      ...
      IF( (ABS(COORD_Y-DOMAIN_Y1) < GEOMETRY_TOLERANCE) ) THEN
        ...
        VALUE = 0.0_CMFEDP
        CALL cmfe_BoundaryConditions_SetNode(BoundaryConditionsDarcy,DependentFieldSolid,CMFE_FIELD_V_VARIABLE_TYPE,1, &
          & CMFE_NO_GLOBAL_DERIV,NODE_NUMBER,2_CMFEIntg,CMFE_BOUNDARY_CONDITION_FIXED,VALUE,Err)
...
!           & NODE_NUMBER,2_CMFEIntg,CMFE_BOUNDARY_CONDITION_FIXED,VALUE,Err)
      ...
      IF( (ABS(COORD_Z-DOMAIN_Z1) < GEOMETRY_TOLERANCE) ) THEN
        ...
        VALUE = 5.0_CMFEDP
        CALL cmfe_BoundaryConditions_SetNode(BoundaryConditionsDarcy,DependentFieldSolid,CMFE_FIELD_V_VARIABLE_TYPE,1, &
          & CMFE_NO_GLOBAL_DERIV,NODE_NUMBER,3_CMFEIntg,CMFE_BOUNDARY_CONDITION_FIXED,VALUE,Err)
...
!           & NODE_NUMBER,3_CMFEIntg,CMFE_BOUNDARY_CONDITION_FIXED,VALUE,Err)
      ...
      IF( (ABS(COORD_Z-DOMAIN_Z2) < GEOMETRY_TOLERANCE) ) THEN
        ...
        CALL cmfe_BoundaryConditions_SetNode(BoundaryConditionsSolid,DependentFieldSolid,CMFE_FIELD_U_VARIABLE_TYPE,1,1, &
            ...
            VALUE = COORD_Y
            CALL cmfe_BoundaryConditions_SetNode(BoundaryConditionsSolid,DependentFieldSolid,CMFE_FIELD_U_VARIABLE_TYPE,1, &
              & CMFE_NO_GLOBAL_DERIV,NODE_NUMBER,2_CMFEIntg,CMFE_BOUNDARY_CONDITION_FIXED,VALUE,Err)
