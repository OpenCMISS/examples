...
PROGRAM LARGEQUADRATICTETEXAMPLE
  ...
  INTEGER(CMFEIntg), PARAMETER :: BasisQuadserNumberQuad=1
  INTEGER(CMFEIntg), PARAMETER :: BasisQuadserNumberLin=2
  INTEGER(CMFEIntg), PARAMETER :: MeshUserNumber=1
  INTEGER(CMFEIntg), PARAMETER :: DecompositionUserNumber=1

  INTEGER(CMFEIntg), PARAMETER :: TotalNumberOfElements=5
  INTEGER(CMFEIntg), PARAMETER :: TotalNumberOfNodes=26
  ...
  INTEGER(CMFEIntg), PARAMETER :: MeshComponentNumberQuad=1
  INTEGER(CMFEIntg), PARAMETER :: MeshComponentNumberLin=2
  ...
  FibreFieldAngle=[1.0_CMFEDP,1.0_CMFEDP,1.0_CMFEDP]
