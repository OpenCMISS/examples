...
gfx modify spectrum flow linear range -1.25 -1 extend_above extend_below rainbow colour_range 0 1 component 2;

gfx def field vector_field coord rectangular_cartesian component general.1 general.2 0

gfx cre spectrum pressure
gfx modify spectrum pressure linear reverse range -3 7 extend_above extend_below rainbow colour_range 0 1 component 3;
