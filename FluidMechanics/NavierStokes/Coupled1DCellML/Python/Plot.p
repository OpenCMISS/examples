...
set xlabel "Time (s)"
#set yrange [-0.2:1.0]
plot 'Results/node_1'  using 1:2 title 'abd aorta' with lines ls 1,\
     'Results/node_2'  using 1:2 title 'com iliac' with lines ls 3,\
     'Results/node_3'  using 1:2 title 'ext iliac' with lines ls 5,\
...
plot 'Results/node_1'  using 1:3 title 'Normal' with lines ls 1,\
     'Results/node_2'  using 1:3 title 'Stenosis' with lines ls 3,\
