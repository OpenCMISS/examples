...
This example demonstrates the application of an mechanical extension to a homogeneous pipe model along the axis of the pipe. The Mooney-Rivlin constitutive law is used via CellML.
