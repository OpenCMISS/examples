...
!   INTEGER:: I,J,K,L,M,N
! 
!        OPEN(UNIT=1, FILE='./output/rhs.vec',STATUS='unknown')
! 
!        DO I=1,12059
!            WRITE(1,*)I, REGION%equations_sets%equations_sets(1)%ptr%equations%equations_matrices%rhs_vector%vector%cmiss%data_dp(I)
!        END DO
! 
!        CLOSE(1)
! 
!        OPEN(UNIT=2, FILE='./output/linear.mat',STATUS='unknown')
! 
!        DO I=1,12059
!         DO J=1,12059 
!            WRITE(2,*)I,J,
