...
!   INTEGER(CMISSIntg) :: MPI_IERROR
  ...
  CALL CMISSDecomposition_ElementDomainSet(Decomposition,1,0,Err)
  CALL CMISSDecomposition_ElementDomainSet(Decomposition,2,0,Err)
  CALL CMISSDecomposition_ElementDomainSet(Decomposition,3,0,Err)
  CALL CMISSDecomposition_ElementDomainSet(Decomposition,4,1,Err)
  CALL CMISSDecomposition_ElementDomainSet(Decomposition,5,1,Err)
  CALL CMISSDecomposition_ElementDomainSet(Decomposition,6,1,Err)
  CALL CMISSDecomposition_ElementDomainSet(Decomposition,7,1,Err)
  CALL CMISSDecomposition_ElementDomainSet(Decomposition,8,1,Err)
