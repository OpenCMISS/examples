MODULE IMPORT_CMHEART
  ...
  USE DARCY_PARAMETERS, ONLY: DEBUG
...
SUBROUTINE READ_AUX
  ...
  IF( DEBUG ) write(73,*)'READ_AUX from NIMZ = ',NIMZ
...
50 CLOSE(1)
      ...
      IF( DEBUG ) THEN
        WRITE(73,*)'BASE_INFO%n_B',BASE_INFO%n_B
        WRITE(73,*)'BASE_INFO%n_pts',BASE_INFO%n_pts
        WRITE(73,*)'BASE_INFO%VL',BASE_INFO%VL
        WRITE(73,*)'BASE_INFO%n_pts_f',BASE_INFO%n_pts_f
        WRITE(73,*)'BASE_INFO%FACES',BASE_INFO%FACES
        WRITE(73,*)'BASE_INFO%FNODES',BASE_INFO%FNODES
        WRITE(73,*)'BASE_INFO%HEXA',BASE_INFO%HEXA
        WRITE(73,*)'BASE_INFO%DM',BASE_INFO%DM
        WRITE(73,*)'BASE_INFO%TRI_BASIS',BASE_INFO%TRI_BASIS
        WRITE(73,*)'BASE_INFO%TET_BASIS',BASE_INFO%TET_BASIS
        WRITE(73,*)'BASE_INFO%QUAD_BASIS',BASE_INFO%QUAD_BASIS
        WRITE(73,*)'BASE_INFO%HEX_BASIS',BASE_INFO%HEX_BASIS
      END IF
...
SUBROUTINE READ_NODES
      ...
      INTEGER:: I,J,K,L,M,N
      INTEGER:: a,b
      DOUBLE PRECISION,ALLOCATABLE:: chrm_test_array(:)
     
      READ(42,*) NAMz

      IF( DEBUG ) write(73,*)'READ_NODES from NAMz = ',NAMz
...
!      IF (DIMEN==2)THEN
!           ALLOCATE(chrm_test_array(MESH_INFO(1)%Lx))
! 
!           chrm_test_array(:)=MESH_INFO(1)%X(:,3)
!           MESH_INFO(1)%X(:,3)=MESH_INFO(1)%X(:,2)
!           MESH_INFO(1)%X(:,2)=chrm_test_array(:)
!      END IF
...
SUBROUTINE READ_ELEMENTS
      ...
      IF( DEBUG ) write(73,*)'READ_ELEMENTS from NAMz = ',NAMz
