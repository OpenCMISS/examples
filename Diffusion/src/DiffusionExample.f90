...
PROGRAM DIFFUSIONEXAMPLE
  ...
  !Set matrix lumping
  CALL EQUATIONS_SET_EQUATIONS_LUMPING_SET(EQUATIONS_SET,EQUATIONS_SET_UNLUMPED_MATRICES,ERR,ERROR,*999)
  !CALL EQUATIONS_SET_EQUATIONS_LUMPING_SET(EQUATIONS_SET,EQUATIONS_SET_LUMPED_MATRICES,ERR,ERROR,*999)
