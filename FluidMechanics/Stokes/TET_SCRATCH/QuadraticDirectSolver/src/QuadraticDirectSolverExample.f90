...
!   READ(*,*) 
  ...
  IF(NUMBER_OF_DIMENSIONS==2) THEN
    ...
    IF(BASIS_TYPE/=CMISSBasisSimplexType) CALL CMISSBasisQuadratureNumberOfGaussXiSet(BasisSpace, & 
      & (/BASIS_XI_GAUSS_SPACE,BASIS_XI_GAUSS_SPACE/),Err)
  ELSE IF(NUMBER_OF_DIMENSIONS==3) THEN
    ...
    IF(BASIS_TYPE/=CMISSBasisSimplexType) CALL CMISSBasisQuadratureNumberOfGaussXiSet(BasisSpace, & 
      & (/BASIS_XI_GAUSS_SPACE,BASIS_XI_GAUSS_SPACE,BASIS_XI_GAUSS_SPACE/),Err)
  ENDIF
  ...
  ELSE
    ...
    IF(NUMBER_OF_DIMENSIONS==2) THEN
      ...
      IF(BASIS_TYPE/=CMISSBasisSimplexType) CALL CMISSBasisQuadratureNumberOfGaussXiSet(BasisVelocity, & 
        & (/BASIS_XI_GAUSS_VELOCITY,BASIS_XI_GAUSS_VELOCITY/),Err)
    ELSE IF(NUMBER_OF_DIMENSIONS==3) THEN
      ...
      IF(BASIS_TYPE/=CMISSBasisSimplexType) CALL CMISSBasisQuadratureNumberOfGaussXiSet(BasisVelocity, & 
        & (/BASIS_XI_GAUSS_VELOCITY,BASIS_XI_GAUSS_VELOCITY,BASIS_XI_GAUSS_VELOCITY/),Err)
    ENDIF
    !Finish the creation of the basis
  ...
  ELSE
    ...
    IF(NUMBER_OF_DIMENSIONS==2) THEN
      ...
      IF(BASIS_TYPE/=CMISSBasisSimplexType) CALL CMISSBasisQuadratureNumberOfGaussXiSet(BasisPressure, & 
        & (/BASIS_XI_GAUSS_PRESSURE,BASIS_XI_GAUSS_PRESSURE/),Err)
    ELSE IF(NUMBER_OF_DIMENSIONS==3) THEN
      ...
      IF(BASIS_TYPE/=CMISSBasisSimplexType) CALL CMISSBasisQuadratureNumberOfGaussXiSet(BasisPressure, & 
        & (/BASIS_XI_GAUSS_PRESSURE,BASIS_XI_GAUSS_PRESSURE,BASIS_XI_GAUSS_PRESSURE/),Err)
    ENDIF
    !Finish the creation of the basis
