...
!   CALL CMISSEquationsLumpingTypeSet(EquationsDarcy,CMISSEquationsUnlumpedMatrices,Err)
  ...
  CALL CMISSProblemSolverGet(Problem,(/ControlLoopSolidNumber,CMISSControlLoopNode/),SolverSolidNumber,SolverSolid,Err)
...
!   CALL CMISSSolverLinearTypeSet(LinearSolverSolid,CMISSSolverLinearDirectSolveType,Err)
  ...
  CALL CMISSProblemSolverGet(Problem,(/ControlLoopFluidNumber,CMISSControlLoopNode/),SolverMatPropertiesNumber, &
  ...
  CALL CMISSProblemSolverGet(Problem,(/ControlLoopFluidNumber,CMISSControlLoopNode/),SolverDarcyNumber,LinearSolverDarcy,Err)
  !Set the output type
