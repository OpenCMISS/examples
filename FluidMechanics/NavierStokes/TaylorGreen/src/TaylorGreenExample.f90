...
!==============================================================
  ...
  REAL(CMFEDP), PARAMETER :: U_0=1.0_CMFEDP !Characteristic velocity (velocity boundary amplitude at t=0)
  REAL(CMFEDP), PARAMETER :: LENGTH=1.0_CMFEDP !Length scale (length of one side of the square)
  REAL(CMFEDP), PARAMETER :: VISCOSITY=0.01_CMFEDP
  REAL(CMFEDP), PARAMETER :: DENSITY=1.0_CMFEDP
  REAL(CMFEDP), PARAMETER :: START_TIME=0.0_CMFEDP
  REAL(CMFEDP), PARAMETER :: STOP_TIME=1.0001_CMFEDP
  REAL(CMFEDP), PARAMETER :: TIME_INCREMENT=0.01_CMFEDP
  REAL(CMFEDP), PARAMETER :: THETA=1.0_CMFEDP
  INTEGER(CMFEIntg), PARAMETER :: OUTPUT_FREQUENCY=1
...
!   INTEGER(CMFEIntg) :: MPI_IERROR
  INTEGER(CMFEIntg) :: NUMBER_OF_BOUNDARY_NODES_NAVIER_STOKES
