...
!> Main program
PROGRAM ADVECTIONDIFFUSIONIO_BCSEXAMPLE
...
#include "mpif.h"
  ...
  INTEGER(CMISSIntg), PARAMETER :: DependentFieldUserNumberAdvecDiff=9
  INTEGER(CMISSIntg), PARAMETER :: MaterialsFieldUserNumberAdvecDiff=10
  INTEGER(CMISSIntg), PARAMETER :: EquationsSetUserNumberAdvecDiff=11
  INTEGER(CMISSIntg), PARAMETER :: ProblemUserNumber=12
  INTEGER(CMISSIntg), PARAMETER :: ControlLoopNode=0
  INTEGER(CMISSIntg), PARAMETER :: IndependentFieldUserNumberAdvecDiff=13
  !INTEGER(CMISSIntg), PARAMETER :: AnalyticFieldUserNumber=14
  INTEGER(CMISSIntg), PARAMETER :: SourceFieldUserNumberAdvecDiff=15
...
!  INTEGER(CMISSIntg) :: MPI_IERROR
  ...
  WRITE (*,*) NUMBER_OF_NODES_CONCENTRATION
  ...
  FIXED_WALL_NODES_ADVECTION_DIFFUSION_FLAG=.TRUE.
  INLET_WALL_NODES_ADVECTION_DIFFUSION_FLAG=.FALSE.
  IF(FIXED_WALL_NODES_ADVECTION_DIFFUSION_FLAG) THEN
    NUMBER_OF_FIXED_WALL_NODES_ADVECTION_DIFFUSION=105
    ALLOCATE(FIXED_WALL_NODES_ADVECTION_DIFFUSION(NUMBER_OF_FIXED_WALL_NODES_ADVECTION_DIFFUSION))
    FIXED_WALL_NODES_ADVECTION_DIFFUSION=[4,11,12,13,29,33,34,35,47,51,52,53,69,71,83,87,88,89,100,102,103,104,112,114,115, & 
  ...
  CALL cmfe_EquationsSet_CreateStart(EquationsSetUserNumberAdvecDiff,Region,GeometricField, &
    ...
    & CMFE_EQUATIONS_SET_NO_SOURCE_ADVECTION_DIFFUSION_SUBTYPE],EquationsSetFieldUserNumber,EquationsSetField, &
...
!   ENDIF
  ...
  CALL cmfe_Problem_CreateStart(ProblemUserNumber,[CMFE_PROBLEM_CLASSICAL_FIELD_CLASS, &
    & CMFE_PROBLEM_ADVECTION_DIFFUSION_EQUATION_TYPE,CMFE_PROBLEM_NO_SOURCE_ADVECTION_DIFFUSION_SUBTYPE],Problem,Err)
  ...
  !Set the times
  CALL cmfe_ControlLoop_TimesSet(ControlLoop,0.0_CMISSRP,0.3_CMISSRP,0.1_CMISSRP,Err)
...
!       ENDDO
  ...
  IF(EXPORT_FIELD_IO) THEN
    ...
    CALL cmfe_Fields_NodesExport(Fields,"AdvectionDiffusionIO_BCs","FORTRAN",Err)
    CALL cmfe_Fields_ElementsExport(Fields,"AdvectionDiffusionIO_BCs","FORTRAN",Err)
...
END PROGRAM ADVECTIONDIFFUSIONIO_BCSEXAMPLE
