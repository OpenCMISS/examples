...
!   CALL MPI_BCAST(NumberOfDomains,1,MPI_INTEGER,0,MPI_COMM_WORLD,MPI_IERROR)
  ...
  CALL CMISSFieldComponentInterpolationSet(MaterialField,CMISSFieldUVariableType,4,CMISSFieldConstantInterpolation,Err)
  CALL CMISSFieldCreateFinish(MaterialField,Err)

  !Set Guccione constants to c1 = 0.831, c2 = 14.31, c3 = 4.49, c4 = 10.0
  CALL CMISSFieldComponentValuesInitialise(MaterialField,CMISSFieldUVariableType,CMISSFieldValuesSetType,1,C(1),Err) !0.831_CMISSDP
  CALL CMISSFieldComponentValuesInitialise(MaterialField,CMISSFieldUVariableType,CMISSFieldValuesSetType,2,C(2),Err) !14.31_CMISSDP
  CALL CMISSFieldComponentValuesInitialise(MaterialField,CMISSFieldUVariableType,CMISSFieldValuesSetType,3,C(3),Err)  !4.49_CMISSDP
  CALL CMISSFieldComponentValuesInitialise(MaterialField,CMISSFieldUVariableType,CMISSFieldValuesSetType,4,C(4),Err) !10.0_CMISSDP
  ...
  CALL CMISSEquationsSetCreateStart(EquationSetUserNumber,Region,FibreField,CMISSEquationsSetElasticityClass, &
    & CMISSEquationsSetFiniteElasticityType,CMISSEquationsSetTransverseIsotropicGuccioneSubtype,EquationsSetFieldUserNumber,&
    & EquationsSetField,EquationsSet,Err)
  ! CMISSEquationsSetOrthotropicMaterialCostaSubtype,CMISSEquationsSetNoSubtype,CMISSEquationsSetTransverseIsotropicGuccioneSubtype
