!> \file
!> $Id: LinearTetExample.f90 20 2007-05-28 20:22:52Z cpb $
...
PROGRAM LINEARTETEXAMPLE
  ...
  CALL CMISSFieldIONodesExport(Fields,"LinearTet","FORTRAN",Err)
  CALL CMISSFieldIOElementsExport(Fields,"LinearTet","FORTRAN",Err)
