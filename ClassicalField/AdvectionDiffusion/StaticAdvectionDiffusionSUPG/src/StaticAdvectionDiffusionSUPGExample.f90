...
!> Main program
PROGRAM STATICADVECTIONDIFFUSIONSUPGEXAMPLE
...
!  ENDIF
  ...
  CALL CMISSEquationsSet_CreateStart(EquationsSetUserNumber,Region,GeometricField,CMISS_EQUATIONS_SET_CLASSICAL_FIELD_CLASS, &
    & CMISS_EQUATIONS_SET_ADVECTION_DIFFUSION_EQUATION_TYPE,CMISS_EQUATIONS_SET_CONST_SOURCE_STATIC_ADVEC_DIFF_SUPG_SUBTYPE,&
...
CALL CMISSSolverEquations_BoundaryConditionsCreateFinish(SolverEquations,Err)
 ...
 !Output Analytic analysis
  Call CMISSAnalyticAnalysisOutput(DependentField,"StaticAdvectionDiffusionSUPGAnalytics",Err)

  EXPORT_FIELD=.TRUE.
  IF(EXPORT_FIELD) THEN
    CALL CMISSFields_Initialise(Fields,Err)
    CALL CMISSFields_Create(Region,Fields,Err)
    CALL CMISSFields_NodesExport(Fields,"StaticAdvectionDiffusionSUPG","FORTRAN",Err)
    CALL CMISSFields_ElementsExport(Fields,"StaticAdvectionDiffusionSUPG","FORTRAN",Err)
    CALL CMISSFields_Finalise(Fields,Err)
...
END PROGRAM STATICADVECTIONDIFFUSIONSUPGEXAMPLE
