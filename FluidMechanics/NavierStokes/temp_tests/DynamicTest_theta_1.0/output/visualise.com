...
gfx define field test coordinate_system rectangular_cartesian composite general.1 general.2;
gfx define field vector_field coordinate_system rectangular_cartesian composite general;
gfx define field mag coordinate_system rectangular_cartesian magnitude field test;
...
gfx modify g_element OpenCMISS node_points glyph arrow_solid general size "0.1*0.1*0.1" centre 0,0,0 font default orientation test scale_factors "0.1*0.1*0.1" select_on material default data mag spectrum default selected_material default_selected;
gfx modify g_element OpenCMISS surfaces select_on invisible material default data general spectrum pressure selected_material default_selected render_shaded;
...
gfx modify window 1 view parallel eye_point 1.50285 2.67458 9.06303 interest_point 1.50285 2.67458 0 up_vector -0 1 -0 view_angle 19.5821 near_clipping_plane 0.0906303 far_clipping_plane 32.3882 relative_viewport ndc_placement -1 1 2 2 viewport_coordinates 0 0 1 1;
