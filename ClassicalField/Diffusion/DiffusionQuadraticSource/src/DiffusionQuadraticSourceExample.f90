...
PROGRAM DIFFUSIONQUADRATICSOURCEEXAMPLE
  ...
  CALL CMISSEquationsSet_CreateStart(EquationsSetUserNumber,Region,GeometricField,CMISS_EQUATIONS_SET_CLASSICAL_FIELD_CLASS, &
    & CMISS_EQUATIONS_SET_DIFFUSION_EQUATION_TYPE,CMISS_EQUATIONS_SET_QUADRATIC_SOURCE_DIFFUSION_SUBTYPE, &
  ...
  CALL CMISSField_ComponentValuesInitialise(MaterialsField,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE,1,0.0_CMISSDP, &
    & Err)
  ...
  CALL CMISSFields_NodesExport(Fields,"DiffusionQuadraticSource","FORTRAN",Err)
  CALL CMISSFields_ElementsExport(Fields,"DiffusionQuadraticSource","FORTRAN",Err)
