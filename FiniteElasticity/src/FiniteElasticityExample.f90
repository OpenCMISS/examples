...
PROGRAM FINITEELASTICITYEXAMPLE
  ...
  TYPE(FIELD_TYPE), POINTER :: GEOMETRIC_FIELD,FIBRE_FIELD,MATERIAL_FIELD,DEPENDENT_FIELD,TEST
  ...
  TYPE(MESH_ELEMENTS_TYPE), POINTER :: ELEMENTS1,ELEMENTS2
  ...
  !my variables
  INTEGER(INTG) :: coordinate_system_user_number,number_of_spatial_dimensions  
  INTEGER(INTG) :: region_user_number
  INTEGER(INTG) :: basis_user_number1,basis_user_number2,number_of_xi_coordinates  
  INTEGER(INTG) :: total_number_of_nodes,number_of_nodes_mesh_component_1,node_idx,global_node_number  
  INTEGER(INTG) :: mesh_user_number,number_of_mesh_dimensions,number_of_mesh_components
  INTEGER(INTG) :: total_number_of_elements,mesh_component_number1,mesh_component_number2
  ...
  !Define basis 1 - tri-linear Lagrange  
  basis_user_number1=1 
  number_of_xi_coordinates=3   
  CALL BASIS_CREATE_START(basis_user_number1,BASIS1,ERR,ERROR,*999) 
  CALL BASIS_TYPE_SET(basis_user_number1,BASIS_LAGRANGE_HERMITE_TP_TYPE,ERR,ERROR,*999)
  CALL BASIS_NUMBER_OF_XI_SET(BASIS1,number_of_xi_coordinates,ERR,ERROR,*999)
  CALL BASIS_INTERPOLATION_XI_SET(basis_user_number1,(/BASIS_LINEAR_LAGRANGE_INTERPOLATION, &
    & BASIS_LINEAR_LAGRANGE_INTERPOLATION,BASIS_LINEAR_LAGRANGE_INTERPOLATION/),ERR,ERROR,*999)
  CALL BASIS_QUADRATURE_NUMBER_OF_GAUSS_XI_SET(basis_user_number1, &
  ...
  !Define basis 2 - tri-cubic Hermite  
  basis_user_number2=2
  number_of_xi_coordinates=3  
  CALL BASIS_CREATE_START(basis_user_number2,BASIS2,ERR,ERROR,*999) 
  CALL BASIS_TYPE_SET(basis_user_number2,BASIS_LAGRANGE_HERMITE_TP_TYPE,ERR,ERROR,*999) 
  CALL BASIS_NUMBER_OF_XI_SET(BASIS2,number_of_xi_coordinates,ERR,ERROR,*999)
  CALL BASIS_INTERPOLATION_XI_SET(basis_user_number2,(/BASIS_CUBIC_HERMITE_INTERPOLATION, &
  ...
  mesh_component_number1=1 
  CALL MESH_TOPOLOGY_ELEMENTS_CREATE_START(MESH,mesh_component_number1,BASIS1,ELEMENTS1,ERR,ERROR,*999)
  CALL MESH_TOPOLOGY_ELEMENTS_ELEMENT_NODES_SET(1,ELEMENTS1,(/1,2,3,4,5,6,7,8/),ERR,ERROR,*999)
  CALL MESH_TOPOLOGY_ELEMENTS_CREATE_FINISH(MESH,mesh_component_number1,ERR,ERROR,*999)
      
  !mesh_component_number2=2
  !CALL MESH_TOPOLOGY_ELEMENTS_CREATE_START(MESH,mesh_component_number2,BASIS2,ELEMENTS2,ERR,ERROR,*999)
  !CALL MESH_TOPOLOGY_ELEMENTS_ELEMENT_NODES_SET(1,ELEMENTS2,(/1,2,3,4,5,6,7,8/),ERR,ERROR,*999)
  !CALL MESH_TOPOLOGY_ELEMENTS_CREATE_FINISH(MESH,mesh_component_number2,ERR,ERROR,*999)
  ...
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(GEOMETRIC_FIELD,FIELD_U_VARIABLE_TYPE,1,mesh_component_number1,ERR,ERROR,*999)
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(GEOMETRIC_FIELD,FIELD_U_VARIABLE_TYPE,2,mesh_component_number1,ERR,ERROR,*999)
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(GEOMETRIC_FIELD,FIELD_U_VARIABLE_TYPE,3,mesh_component_number1,ERR,ERROR,*999)
  ...
  !node 2
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,1,2,1,1.1_DP,ERR,ERROR,*999)
  ...
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(FIBRE_FIELD,FIELD_U_VARIABLE_TYPE,1,mesh_component_number1,ERR,ERROR,*999)
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(FIBRE_FIELD,FIELD_U_VARIABLE_TYPE,2,mesh_component_number1,ERR,ERROR,*999)
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(FIBRE_FIELD,FIELD_U_VARIABLE_TYPE,3,mesh_component_number1,ERR,ERROR,*999)
  ...
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(MATERIAL_FIELD,FIELD_U_VARIABLE_TYPE,1,mesh_component_number1,ERR,ERROR,*999)
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(MATERIAL_FIELD,FIELD_U_VARIABLE_TYPE,2,mesh_component_number1,ERR,ERROR,*999)
  ...
  total_number_of_nodes=mesh%TOPOLOGY(mesh_component_number1)%PTR%NODES%NUMBER_OF_NODES
  DO node_idx=1,total_number_of_nodes
    global_node_number=MESH%TOPOLOGY(mesh_component_number1)%PTR%NODES%NODES(node_idx)%GLOBAL_NUMBER
    CALL FIELD_PARAMETER_SET_UPDATE_NODE(MATERIAL_FIELD,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,1,node_idx,1,2.0_DP, &
      & ERR,ERROR,*999)
    CALL FIELD_PARAMETER_SET_UPDATE_NODE(MATERIAL_FIELD,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,1,node_idx,2,3.0_DP, &
      & ERR,ERROR,*999)
  ENDDO
  
  !Create a dependent field with four components
  ...
  CALL FIELD_NUMBER_OF_VARIABLES_SET(DEPENDENT_FIELD,2,ERR,ERROR,*999)
  CALL FIELD_NUMBER_OF_COMPONENTS_SET(DEPENDENT_FIELD,FIELD_U_VARIABLE_TYPE,4,ERR,ERROR,*999)    
  CALL FIELD_NUMBER_OF_COMPONENTS_SET(DEPENDENT_FIELD,FIELD_DELUDELN_VARIABLE_TYPE,4,ERR,ERROR,*999)    
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(DEPENDENT_FIELD,FIELD_U_VARIABLE_TYPE,1,mesh_component_number1,ERR,ERROR,*999)
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(DEPENDENT_FIELD,FIELD_U_VARIABLE_TYPE,2,mesh_component_number1,ERR,ERROR,*999)
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(DEPENDENT_FIELD,FIELD_U_VARIABLE_TYPE,3,mesh_component_number1,ERR,ERROR,*999)  
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(DEPENDENT_FIELD,FIELD_DELUDELN_VARIABLE_TYPE,1,mesh_component_number1,ERR,ERROR,*999)
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(DEPENDENT_FIELD,FIELD_DELUDELN_VARIABLE_TYPE,2,mesh_component_number1,ERR,ERROR,*999)
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(DEPENDENT_FIELD,FIELD_DELUDELN_VARIABLE_TYPE,3,mesh_component_number1,ERR,ERROR,*999)  
  ...
  CALL EQUATIONS_SET_BOUNDARY_CONDITIONS_CREATE_START(EQUATIONS_SET,ERR,ERROR,*999)
  ...
  CALL BOUNDARY_CONDITIONS_SET_NODE(BOUNDARY_CONDITIONS,FIELD_U_VARIABLE_TYPE,1,2,1,BOUNDARY_CONDITION_FIXED,0.1_DP,ERR,ERROR,*999)
  ...
  CALL BOUNDARY_CONDITIONS_SET_NODE(BOUNDARY_CONDITIONS,FIELD_U_VARIABLE_TYPE,1,4,1,BOUNDARY_CONDITION_FIXED,0.1_DP,ERR,ERROR,*999)
  ...
  CALL BOUNDARY_CONDITIONS_SET_NODE(BOUNDARY_CONDITIONS,FIELD_U_VARIABLE_TYPE,1,6,1,BOUNDARY_CONDITION_FIXED,0.1_DP,ERR,ERROR,*999)
  ...
  CALL BOUNDARY_CONDITIONS_SET_NODE(BOUNDARY_CONDITIONS,FIELD_U_VARIABLE_TYPE,1,8,1,BOUNDARY_CONDITION_FIXED,0.1_DP,ERR,ERROR,*999)
  ...
  CALL BOUNDARY_CONDITIONS_SET_NODE(BOUNDARY_CONDITIONS,FIELD_U_VARIABLE_TYPE,1,3,2,BOUNDARY_CONDITION_FIXED,0.0_DP,ERR,ERROR,*999)
  ...
  CALL BOUNDARY_CONDITIONS_SET_NODE(BOUNDARY_CONDITIONS,FIELD_U_VARIABLE_TYPE,1,7,2,BOUNDARY_CONDITION_FIXED,0.0_DP,ERR,ERROR,*999)
  ...
  CALL BOUNDARY_CONDITIONS_SET_NODE(BOUNDARY_CONDITIONS,FIELD_U_VARIABLE_TYPE,1,5,3,BOUNDARY_CONDITION_FIXED,0.0_DP,ERR,ERROR,*999)
  CALL BOUNDARY_CONDITIONS_SET_NODE(BOUNDARY_CONDITIONS,FIELD_U_VARIABLE_TYPE,1,7,3,BOUNDARY_CONDITION_FIXED,0.0_DP,ERR,ERROR,*999)
