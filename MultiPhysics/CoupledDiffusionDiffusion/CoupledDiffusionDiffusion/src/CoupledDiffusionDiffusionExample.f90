...
PROGRAM COUPLEDSOURCEDIFFUSIONDIFFUSIONEXAMPLE
  ...
  INTEGER(CMFEIntg), PARAMETER :: DependentFieldUserNumberDiffusionOne=6
  INTEGER(CMFEIntg), PARAMETER :: DependentFieldUserNumberDiffusionTwo=7
  INTEGER(CMFEIntg), PARAMETER :: MaterialsFieldUserNumberDiffusionOne=8
  INTEGER(CMFEIntg), PARAMETER :: MaterialsFieldUserNumberDiffusionTwo=9
  INTEGER(CMFEIntg), PARAMETER :: SourceFieldUserNumberDiffusionOne=10
  INTEGER(CMFEIntg), PARAMETER :: SourceFieldUserNumberDiffusionTwo=11
  INTEGER(CMFEIntg), PARAMETER :: EquationsSetUserNumberDiffusionOne=12
  ...
  INTEGER(CMFEIntg), PARAMETER :: SolverDiffusionOneUserNumber=1
  INTEGER(CMFEIntg), PARAMETER :: SolverDiffusionTwoUserNumber=2
  ...
  INTEGER(CMFEIntg) :: EQUATIONS_DIFFUSION_ONE_OUTPUT
  ...
  INTEGER(CMFEIntg) :: LINEAR_SOLVER_DIFFUSION_ONE_OUTPUT_TYPE
  INTEGER(CMFEIntg) :: LINEAR_SOLVER_DIFFUSION_TWO_OUTPUT_TYPE
...
!   DOMAIN_Z2 =  5.0_CMFEDP
  ...
  !Set initial values
  INITIAL_FIELD_DIFFUSION_ONE=0.0_CMFEDP
  INITIAL_FIELD_DIFFUSION_TWO=0.0_CMFEDP
  ...
  ENDIF  !Set material parameters
    ...
    BOUNDARY_CONDITIONS_DIFFUSION_TWO=2.0_CMFEDP
  ...
  LINEAR_SOLVER_DIFFUSION_STOP_TIME=0.250_CMFEDP 
...
!   MESH_NUMBER_OF_ALL_COMPONENTS = MESH_NUMBER_OF_COMPONENTS + NumberOfSolidMeshComponents
  ...
  CALL cmfe_EquationsSet_CreateStart(EquationsSetUserNumberDiffusionOne,Region,GeometricField,[EquationsSetDiffusionOne,Err])
  !Set the equations set to be a linear source diffusion problem
  CALL cmfe_EquationsSet_SpecificationSet(EquationsSetDiffusionOne,CMFE_EQUATIONS_SET_CLASSICAL_FIELD_CLASS, &
    & CMFE_EQUATIONS_SET_DIFFUSION_EQUATION_TYPE,CMFE_EQUATIONS_SET_LINEAR_SOURCE_DIFFUSION_SUBTYPE,Err)
  ...
  CALL cmfe_EquationsSet_CreateStart(EquationsSetUserNumberDiffusionTwo,Region,GeometricField,[EquationsSetDiffusionTwo,Err])
  !Set the equations set to be a constant source diffusion problem
  CALL cmfe_EquationsSet_SpecificationSet(EquationsSetDiffusionTwo,CMFE_EQUATIONS_SET_CLASSICAL_FIELD_CLASS, &
