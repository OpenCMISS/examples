...
PROGRAM NUMBERLAPLACEEXAMPLE
  ...
  REAL(CMISSDP), PARAMETER :: HEIGHT=1.0_DP
  REAL(CMISSDP), PARAMETER :: WIDTH=2.0_DP
  REAL(CMISSDP), PARAMETER :: LENGTH=3.0_DP
  ...
  !Intialise cmiss
  CALL CMISSInitialise(WorldRegionUserNumber,Err)
  ...
  !CALL CMISSEquationsOutputType(RegionUserNumber,EquationsSetUserNumber,CMISSEquationsNoOutput,Err)
  CALL CMISSEquationsOutputType(RegionUserNumber,EquationsSetUserNumber,CMISSEquationsTimingOutput,Err)
  !CALL CMISSEquationsOutputType(RegionUserNumber,EquationsSetUserNumber,CMISSEquationsMatrixOutput,Err)
  !CALL CMISSEquationsOutputType(RegionUserNumber,EquationsSetUserNumber,CMISSEquationsElementMatrixOutput,Err)
