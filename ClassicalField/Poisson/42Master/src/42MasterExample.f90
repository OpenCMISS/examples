...
#include "mpif.h"
  ...
  !Output to a file
  CALL cmfe_OutputSetOn("Poisson",Err)
  ...
  CALL cmfe_EquationsSet_CreateStart(EquationsSetUserNumber,Region,GeometricField,[CMFE_EQUATIONS_SET_CLASSICAL_FIELD_CLASS, &
    & CMFE_EQUATIONS_SET_POISSON_EQUATION_TYPE,CMFE_EQUATIONS_SET_CONSTANT_SOURCE_POISSON_SUBTYPE],EquationsSetFieldUserNumber, &
  ...
  CALL cmfe_Field_ComponentValuesInitialise(DependentField,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,1,1.0_CMFEDP, &
    & Err)
  ...
  CALL cmfe_Field_ComponentValuesInitialise(MaterialsField,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,1,1.0_CMFEDP, &
    & Err)
  ...
  CALL cmfe_Problem_CreateStart(ProblemUserNumber,[CMFE_PROBLEM_CLASSICAL_FIELD_CLASS,CMFE_PROBLEM_POISSON_EQUATION_TYPE, &
    & CMFE_PROBLEM_LINEAR_SOURCE_POISSON_SUBTYPE],Problem,Err)
  ...
  !CALL cmfe_Solver_LinearIterativeRelativeToleranceSet(Solver,1.0E-8_CMFEDP,Err)
  !CALL cmfe_Solver_LinearIterativeAbsoluteToleranceSet(Solver,1.0E-8_CMFEDP,Err)
  ...
  IF(EXPORT_FIELD) THEN
    ...
    CALL cmfe_Fields_NodesExport(Fields,"Poisson","FORTRAN",Err)
    CALL cmfe_Fields_ElementsExport(Fields,"Poisson","FORTRAN",Err)
