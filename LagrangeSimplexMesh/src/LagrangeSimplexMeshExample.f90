...
PROGRAM LAGRANGESIMPLEXMESHEXAMPLE
  ...
  NULLIFY(BASIS2)
  CALL BASIS_CREATE_START(1,BASIS2,ERR,ERROR,*999)
  ...
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_VALUES_SET_TYPE,1,3,1,FIELD_U_VARIABLE_TYPE,1.5_DP,ERR,ERROR,*999)
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_VALUES_SET_TYPE,1,4,1,FIELD_U_VARIABLE_TYPE,2.0_DP,ERR,ERROR,*999)
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_VALUES_SET_TYPE,1,5,1,FIELD_U_VARIABLE_TYPE,0.0_DP,ERR,ERROR,*999)
  ...
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_VALUES_SET_TYPE,1,7,1,FIELD_U_VARIABLE_TYPE,1.5_DP,ERR,ERROR,*999)
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_VALUES_SET_TYPE,1,8,1,FIELD_U_VARIABLE_TYPE,0.0_DP,ERR,ERROR,*999)
  ...
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_VALUES_SET_TYPE,1,4,2,FIELD_U_VARIABLE_TYPE,0.0_DP,ERR,ERROR,*999)
  ...
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_VALUES_SET_TYPE,1,7,2,FIELD_U_VARIABLE_TYPE,0.5_DP,ERR,ERROR,*999)
