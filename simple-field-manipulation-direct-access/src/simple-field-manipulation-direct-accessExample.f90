...
PROGRAM SimpleFieldManipulationExample
  ...
  CALL FIELD_TYPE_SET(field_general_id,REGION,FIELD_GENERAL_TYPE,ERR,ERROR,*999)  
  CALL FIELD_MESH_DECOMPOSITION_SET(GENERAL_FIELD,DECOMPOSITION,ERR,ERROR,*999)
  CALL FIELD_GEOMETRIC_FIELD_SET(field_general_id,REGION,GEOMETRIC_FIELD,ERR,ERROR,*999)
  CALL FIELD_NUMBER_OF_VARIABLES_SET(field_general_id,REGION,field_general_number_of_variables,ERR,ERROR,*999)
  CALL FIELD_NUMBER_OF_COMPONENTS_SET(field_general_id,REGION,field_general_number_of_components,ERR,ERROR,*999)
  DO nc=1,field_general_number_of_components
     CALL FIELD_COMPONENT_MESH_COMPONENT_SET(GENERAL_FIELD,FIELD_STANDARD_VARIABLE_TYPE,nc,1,ERR,ERROR,*999)
  END DO
  !Finish creating the field
