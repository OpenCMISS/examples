...
PROGRAM ANALYTICLAPLACEEXAMPLE
  ...
  USE DISTRIUBTED_MATRIX_VECTOR_IO
  USE DOMAIN_MAPPINGS
  ...
  TYPE(VARYING_STRING) :: FILE, FILENAME, METHOD, FILE_FMT, FILE_STS
...
! Save the problem and solution ?
  ...
  IF(EXPORT_FIELD) THEN
    METHOD="FORTRAN"
    call DISTRIBUTED_MATRIX_VECTOR_IO_CREATE_START(MY_COMPUTATIONAL_NODE_NUMBER, FILE_STS, ERR, ERROR,*999)
    call DISTRIBUTED_MATRIX_VECTOR_IO_MODE_SET(FILE_FMT,ERR,ERROR,*999)
    call DISTRIBUTED_MATRIX_VECTOR_IO_CREATE_FINISH(ERR,ERROR,*999)
    call DISTRIBUTED_MATRIX_VECTOR_IO_FILENAME_SET(FILE,ERR,ERROR,*999)
    call DISTRIBUTED_MATRIX_VECTOR_IO_FILE_OPEN(ERR,ERROR,*999)
    call DISTRIBUTED_MATRIX_VECTOR_IO_HEADER_WRITE(ERR,ERROR,*999)
     
    call DISTRIBUTED_MATRIX_VECTOR_IO_FILE_CLOSE(ERR,ERROR,*999)
