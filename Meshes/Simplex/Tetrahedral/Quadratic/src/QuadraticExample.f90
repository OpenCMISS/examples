!> \file
!> $Id: QuadraticTetrahedraSimplexExample.f90 20 2007-05-28 20:22:52Z cpb $
!> \author Chris Bradley
!> \brief This is an example program to set up a generated mesh of quadratic Simplex tetrahedra elements.
!>
!> \section LICENSE
!>
...
!> \example Meshes/Simplex/Tetrahedral/Quadratic/src/QuadraticExample.f90
!! Example program to to set up a generated mesh of quadratic Simplex tetrahedral elements.
!! \htmlinclude Meshes/Simplex/Tetrahedral/Quadratic/history.html
!!
!<
...
PROGRAM QUADRATICTETRAHEDRASIMPLEXEXAMPLE
  ...
  CALL CMISSFieldIONodesExport(Fields,"QuadraticTetrahedraSimplex","FORTRAN",Err)
  CALL CMISSFieldIOElementsExport(Fields,"QuadraticTetrahedraSimplex","FORTRAN",Err)
...
END PROGRAM QUADRATICTETRAHEDRASIMPLEXEXAMPLE
