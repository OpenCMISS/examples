...
for $i (1..3)
  {
	 $filename = sprintf("./output/S_TIMESTP_%04d.exnode", $i);
...
gfx modify spectrum flow linear reverse range -1.1 1.1 extend_above extend_below rainbow colour_range 0 1 component 1;

gfx def field vector_field coord rectangular_cartesian component general.1 general.2 general.3
#gfx def field vector_field coord rectangular_cartesian component general.1 

gfx cre spectrum pressure
gfx modify spectrum pressure linear reverse range -15.5 -13.0 extend_above extend_below rainbow colour_range 0 1 component 4;
