...
!   INTEGER(CMISSIntg) :: CONDITION
  ...
  DYNAMIC_SOLVER_NAVIER_STOKES_TIME_INCREMENT=0.100_CMISSRP
  ...
  RELATIVE_TOLERANCE=1.0E-8_CMISSRP !default: 1.0E-05_CMISSRP
...
! ! !   ENDIF
  ...
  DO NODE_NUMBER=1,NUMBER_OF_NODES_SPACE
    DO COMPONENT_NUMBER=1,NUMBER_OF_DIMENSIONS
      VALUE=CM%N(NODE_NUMBER,COMPONENT_NUMBER)*0.3141592653589793_CMISSRP
