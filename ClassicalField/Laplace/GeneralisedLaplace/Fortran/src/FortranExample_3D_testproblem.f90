...
!  FibreFieldAngle=(/0.0_CMISSDP,0.0_CMISSDP,0.0_CMISSDP/)
  ...
  FibreFieldAngle=(/PI/4,0.0_CMISSDP,PI/4/)
!  FibreFieldAngle=(/0.0_CMISSDP,PI/4,0.0_CMISSDP/)
!  FibreFieldAngle=(/0.0_CMISSDP,0.0_CMISSDP,PI/4/)
