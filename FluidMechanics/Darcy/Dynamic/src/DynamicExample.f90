...
!   INTEGER(CMISSIntg) :: MPI_IERROR
  ...
  DYNAMIC_SOLVER_DARCY_OUTPUT_TYPE=CMISS_SOLVER_NO_OUTPUT
...
!   CALL CMISSDiagnosticsSetOn(CMISS_IN_DIAG_TYPE,DIAG_LEVEL_LIST,"DarcyDiagnostics",DIAG_ROUTINE_LIST,Err)
  ...
  DO NODE_NUMBER=1,NUMBER_OF_NODES_GEOMETRY
    DO COMPONENT_NUMBER=1,NUMBER_OF_DIMENSIONS
      CALL CMISSDecomposition_NodeDomainGet(Decomposition,NODE_NUMBER,MESH_COMPONENT_NUMBER_GEOMETRY,NodeDomain,Err)
...
CALL CMISSEquationsSet_CreateStart(EquationsSetUserNumberDarcy,Region,GeometricField,CMISS_EQUATIONS_SET_FLUID_MECHANICS_CLASS, &
    & CMISS_EQUATIONS_SET_DARCY_EQUATION_TYPE,CMISS_EQUATIONS_SET_TRANSIENT_DARCY_SUBTYPE,EquationsSetFieldUserNumber, &
      & EquationsSetField, &
  ...
  CALL CMISSProblem_SpecificationSet(Problem,CMISS_PROBLEM_FLUID_MECHANICS_CLASS,CMISS_PROBLEM_DARCY_EQUATION_TYPE, &
    & CMISS_PROBLEM_TRANSIENT_DARCY_SUBTYPE,Err)
  ...
  CALL CMISSProblem_SolverGet(Problem,CMISS_CONTROL_LOOP_NODE,SolverDarcyUserNumber,DynamicSolverDarcy,Err)
  !Set the output type
...
!   CALL CMISSProblem_SolverGet(Problem,CMISS_CONTROL_LOOP_NODE,SolverDarcyUserNumber,LinearSolverDarcy,Err)
  ...
  CALL CMISSProblem_SolverGet(Problem,CMISS_CONTROL_LOOP_NODE,SolverDarcyUserNumber,DynamicSolverDarcy,Err)
  CALL CMISSSolver_SolverEquationsGet(DynamicSolverDarcy,SolverEquationsDarcy,Err)
  ...
  IF(EXPORT_FIELD_IO) THEN
    ...
    CALL CMISSFields_NodesExport(Fields,"DynamicDarcy","FORTRAN",Err)
    CALL CMISSFields_ElementsExport(Fields,"DynamicDarcy","FORTRAN",Err)
