...
!   INTEGER(CMISSIntg) :: MPI_IERROR
  ...
  RHO_PARAM_NAVIER_STOKES=0.0_CMISSDP
  ...
  DYNAMIC_SOLVER_NAVIER_STOKES_STOP_TIME=1.00010_CMISSDP 
  DYNAMIC_SOLVER_NAVIER_STOKES_TIME_INCREMENT=0.5_CMISSDP
...
!  CALL CMISSNodesCreateStart(Region,TOTAL_NUMBER_OF_NODES,Nodes,Err)
  ...
  CALL CMISSDecompositionElementDomainSet(Decomposition,1,0,Err)
  CALL CMISSDecompositionElementDomainSet(Decomposition,2,0,Err)
  CALL CMISSDecompositionElementDomainSet(Decomposition,3,0,Err)
  CALL CMISSDecompositionElementDomainSet(Decomposition,4,1,Err)
  CALL CMISSDecompositionElementDomainSet(Decomposition,5,1,Err)
  CALL CMISSDecompositionElementDomainSet(Decomposition,6,1,Err)
  CALL CMISSDecompositionElementDomainSet(Decomposition,7,1,Err)
  CALL CMISSDecompositionElementDomainSet(Decomposition,8,1,Err)
