...
!   TYPE(CMISSFieldType) :: IndependentFieldMatProperties
  ...
  LINEAR_SOLVER_DARCY_TIME_INCREMENT=1.0_CMISSDP
...
!   CALL CMISSEquationsLumpingTypeSet(EquationsDarcy,CMISSEquationsUnlumpedMatrices,Err)
  ...
  IF(EXPORT_FIELD_IO) THEN
    ...
    CALL CMISSFieldIONodesExport(Fields,"ALEDarcy","FORTRAN",Err)
    CALL CMISSFieldIOElementsExport(Fields,"ALEDarcy","FORTRAN",Err)
