...
plot 'Results/node_1'  using 1:2 title 'inlet' with lines ls 1,\
     'Results/node_1'  using 1:4 title 'outlet-1' with lines ls 3,\
     'Results/node_3'  using 1:4 title 'outlet-2' with lines ls 5,\
     'Results/node_4'  using 1:5 title 'femoral' with lines ls 7,\
...
plot 'Results/node_1'  using 1:3 title 'inlet' with lines ls 1,\
     'Results/node_1'  using 1:5 title 'outlet-1' with lines ls 3,\
