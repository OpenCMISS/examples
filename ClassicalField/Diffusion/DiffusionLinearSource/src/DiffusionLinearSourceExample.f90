...
!> \example ClassicalField/Diffusion/DiffusionLinearSource/src/DiffusionLinearSourceExample.f90
!! Example program to solve a diffusion equation using openCMISS calls.
!!
!! \htmlinclude ClassicalField/Diffusion/DiffusionLinearSource/history.html
!<
...
PROGRAM DIFFUSIONCONSTANTSOURCEEXAMPLE
  ...
  REAL(CMFEDP), PARAMETER :: HEIGHT=1.0_CMFEDP/2.0_CMFEDP
  REAL(CMFEDP), PARAMETER :: WIDTH=2.0_CMFEDP/2.0_CMFEDP
  ...
  INTEGER(CMFEIntg), PARAMETER :: SourceFieldUserNumber=12
  ...
  TYPE(cmfe_FieldType) :: GeometricField,DependentField,MaterialsField,SourceField,AnalyticField
  ...
  CALL MPI_BCAST(NUMBER_OF_DOMAINS,1,MPI_INTEGER,0,MPI_COMM_WORLD,MPI_IERROR)
    ...
    ELSE
     ...
     CALL cmfe_Basis_InterpolationXiSet(Basis,(/2,2, & 
       & 2/),Err)                         
...
CALL cmfe_EquationsSet_CreateStart(EquationsSetUserNumber,Region,GeometricField,[CMFE_EQUATIONS_SET_CLASSICAL_FIELD_CLASS, &
  ...
  !Set the times
  CALL cmfe_ControlLoop_TimesSet(ControlLoop,0.0_CMFEDP,1.0001_CMFEDP,0.001_CMFEDP,Err)
...
! 
 ...
 !Output Analytic analysis
  Call cmfe_AnalyticAnalysisOutput(DependentField,"DiffusionLinearSourceAnalytics",Err)
  ...
  IF(EXPORT_FIELD) THEN
    ...
    CALL cmfe_Fields_NodesExport(Fields,"DiffusionLinearSource","FORTRAN",Err)
    CALL cmfe_Fields_ElementsExport(Fields,"DiffusionLinearSource","FORTRAN",Err)
