...
PROGRAM FINITEELASTICITYEXAMPLE
  ...
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(field_geomtery_user_number,1,1,REGION,mesh_component_number1,ERR,ERROR,*999)
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(field_geomtery_user_number,1,2,REGION,mesh_component_number1,ERR,ERROR,*999)
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(field_geomtery_user_number,1,3,REGION,mesh_component_number1,ERR,ERROR,*999)
  ...
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(field_fibre_user_number,1,1,REGION,mesh_component_number1,ERR,ERROR,*999)
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(field_fibre_user_number,1,2,REGION,mesh_component_number1,ERR,ERROR,*999)
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(field_fibre_user_number,1,3,REGION,mesh_component_number1,ERR,ERROR,*999)
  ...
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(field_material_user_number,1,1,REGION,mesh_component_number1,ERR,ERROR,*999)
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(field_material_user_number,1,2,REGION,mesh_component_number1,ERR,ERROR,*999)
  ...
  CALL FIELD_DEPENDENT_TYPE_SET(4,REGION,FIELD_DEPENDENT_TYPE,ERR,ERROR,*999) 
  CALL FIELD_NUMBER_OF_VARIABLES_SET(4,REGION,2,ERR,ERROR,*999)
  CALL FIELD_NUMBER_OF_COMPONENTS_SET(4,REGION,4,ERR,ERROR,*999)    
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(4,1,1,REGION,mesh_component_number1,ERR,ERROR,*999)
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(4,1,2,REGION,mesh_component_number1,ERR,ERROR,*999)
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(4,1,3,REGION,mesh_component_number1,ERR,ERROR,*999)  
  CALL FIELD_COMPONENT_INTERPOLATION_SET(DEPENDENT_FIELD,1,4,FIELD_ELEMENT_BASED_INTERPOLATION,ERR,ERROR,*999)
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(4,2,1,REGION,mesh_component_number1,ERR,ERROR,*999)
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(4,2,2,REGION,mesh_component_number1,ERR,ERROR,*999)
  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(4,2,3,REGION,mesh_component_number1,ERR,ERROR,*999)  
  ...
  CALL PROBLEM_SOLUTION_EQUATIONS_SET_ADD(PROBLEM,CONTROL_LOOP_NODE,1,EQUATIONS_SET,EQUATIONS_SET_INDEX,ERR,ERROR,*999)
  WRITE(*,'(" TESTING")')
  STOP
