...
PROGRAM COUPLEDDIFFUSIONADVECTIONDIFFUSIONEXAMPLE
  ...
  INTEGER(CMFEIntg), PARAMETER :: DependentFieldUserNumber=6   !combined diffusion & advection-diffusion
!  INTEGER(CMFEIntg), PARAMETER :: DependentFieldUserNumberDiffusion=7
  ...
  INTEGER(CMFEIntg), PARAMETER :: EquationsSetFieldUserNumberAdvectionDiffusion=22
  INTEGER(CMFEIntg), PARAMETER :: EquationsSetFieldUserNumberDiffusion=23
