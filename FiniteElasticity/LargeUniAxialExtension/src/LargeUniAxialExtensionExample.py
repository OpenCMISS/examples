...
#InterpolationType = CMISS.CMISSBasisLinearLagrangeInterpolation
#PressureInterpolationType = CMISS.CMISSBasisLinearLagrangeInterpolation
...
if InterpolationType == 4:
    geometricField.fieldScalingType = CMISSFieldArithmeticMeanScaling
...
if InterpolationType == 4:
    fibreField.fieldScalingType = CMISSFieldArithmeticMeanScaling
...
if InterpolationType == 4:
    dependentField.fieldScalingType = CMISSFieldArithmeticMeanScaling
