...
!###    Index for a partial derivative.
  ...
  !Linear/Linear/Linear Lagrange Basis
  ...
  !Quadratic/Quadratic/Quadratic Lagrange Basis
  !CALL BASIS_INTERPOLATION_XI_SET(BASIS,(/BASIS_QUADRATIC_LAGRANGE_INTERPOLATION, &
  !  & BASIS_QUADRATIC_LAGRANGE_INTERPOLATION,BASIS_QUADRATIC_LAGRANGE_INTERPOLATION/),ERR,ERROR,*999)
  !Cubic/Cubic/Cubic Lagrange Basis
  !CALL BASIS_INTERPOLATION_XI_SET(BASIS,(/BASIS_CUBIC_LAGRANGE_INTERPOLATION, &
  !  & BASIS_CUBIC_LAGRANGE_INTERPOLATION,BASIS_CUBIC_LAGRANGE_INTERPOLATION/),ERR,ERROR,*999)
  !Quadratic/Linear/Linear Lagrange Basis
  !CALL BASIS_INTERPOLATION_XI_SET(BASIS,(/BASIS_QUADRATIC_LAGRANGE_INTERPOLATION, &
  !  & BASIS_LINEAR_LAGRANGE_INTERPOLATION,BASIS_LINEAR_LAGRANGE_INTERPOLATION/),ERR,ERROR,*999)
  CALL BASIS_QUADRATURE_NUMBER_OF_GAUSS_XI_SET(BASIS,(/4,4,4/),ERR,ERROR,*999)  
